...
@Component({
    selector: 'p-steps',
    imports: [NgClass, NgStyle, RouterModule, TooltipModule, SharedModule],
    template: `
                        ...
                        @if (isClickableRouterLink(item)) {
                            ...
                            >
                                ...
                                @if (item.escape !== false) {
                                    <span class="p-steps-item-label">{{ item.label }}</span>
                                } @else {
                                    <span class="p-steps-item-label" [innerHTML]="item.label"></span>
                                }
                            </a>
                        } @else {
                            <a
