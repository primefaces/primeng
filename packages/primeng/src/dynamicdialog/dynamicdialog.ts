...
@Component({
    ...
    imports: [NgStyle, NgClass, NgTemplateOutlet, SharedModule, DynamicDialogContent, WindowMaximizeIcon, WindowMinimizeIcon, TimesIcon, Button, FocusTrap],
    template: `
        <div
            #mask
            [ngStyle]="{
                            ...
                            @if (!headerTemplate) {
                                ...
                                <div [ngClass]="'p-dialog-header-actions'">
                                    @if (ddconfig.maximizable) {
                                        <p-button [styleClass]="'p-dialog-maximize-button'" (onClick)="maximize()" (keydown.enter)="maximize()" [tabindex]="maximizable ? '0' : '-1'">
                                            @if (!maximizeIcon) {
                                    ...
                                    @if (closable) {
                                        <p-button [styleClass]="'p-dialog-close-button'" [ariaLabel]="closeAriaLabel" (onClick)="hide()" (keydown.enter)="hide()" rounded text severity="secondary">
