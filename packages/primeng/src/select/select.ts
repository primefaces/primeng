...
@Component({
    selector: 'p-select',
    imports: [NgClass, NgStyle, NgTemplateOutlet, SelectItem, Overlay, Tooltip, Ripple, AutoFocus, TimesIcon, ChevronDownIcon, SearchIcon, BlankIcon, CheckIcon, InputText, IconField, InputIcon, Scroller, SharedModule],
    template: `
        @if (!editable) {
            <span
                #focusInput
