...
describe('Listbox', () => {
    ...
    describe('Style and CSS Classes', () => {
        ...
        it('should apply custom listStyle', async () => {
            ...
            expect(listboxComponent.listStyle()).toEqual({ height: '300px' });
        });
    });
...
describe('Listbox ViewChild and Advanced Scenarios', () => {
    ...
    describe('All Event Emitters Comprehensive Test', () => {
        it('should emit all events with proper data', async () => {
            ...
            // Test onDblClick - re-query for fresh option element
            const dblClickOption = fixture.debugElement.query(By.css('.p-listbox-option'));
            if (dblClickOption) {
                dblClickOption.nativeElement.dispatchEvent(new MouseEvent('dblclick', { bubbles: true }));
                fixture.changeDetectorRef.markForCheck();
                await fixture.whenStable();
    ...
    describe('PassThrough Tests', () => {
        ...
        describe('Case 4: Using instance variables', () => {
            ...
            it('should apply PT based on instance multiple state', async () => {
                ...
                ptFixture.componentRef.setInput('pt', {
                    list: ({ instance }: any) => ({
                        style: {
                            'background-color': instance?.multiple && instance.multiple() ? 'yellow' : 'white'
                        }
                    })
                });
                ptFixture.changeDetectorRef.markForCheck();
            ...
            it('should apply PT based on instance filter state', async () => {
                ...
                ptFixture.componentRef.setInput('pt', {
                    header: ({ instance }: any) => ({
                        style: {
                            'border-color': instance?.filter && instance.filter() ? 'green' : 'gray'
                        }
                    })
                });
                ptFixture.changeDetectorRef.markForCheck();
        ...
        describe('Case 9: Component-Specific Methods', () => {
            it('should use getPTOptions method for option rendering', async () => {
                ...
                const opts = listbox.options()!;
                const ptOptions = listbox.getPTOptions(opts[0], {}, 0, 'option');
            ...
            it('should export correct context via getPTOptions for selected option', async () => {
                ...
                const ptOptionsForSelected = listbox.getPTOptions(opts[0], {}, 0, 'option');
                ...
                const ptOptionsForNonSelected = listbox.getPTOptions(opts[1], {}, 1, 'option');
            ...
            it('should export correct context via getPTOptions for disabled option', async () => {
                ...
                ptFixture.componentRef.setInput('options', opts);
                ptFixture.componentRef.setInput('optionDisabled', 'disabled');
                ptFixture.changeDetectorRef.markForCheck();
                await ptFixture.whenStable();

                // Get PT options for disabled option
                const ptOptionsForDisabled = listbox.getPTOptions(opts[1], {}, 1, 'option');
                ...
                const ptOptionsForEnabled = listbox.getPTOptions(opts[0], {}, 0, 'option');
            ...
            it('should export correct context via getPTOptions for focused option', async () => {
                ...
                const ptOptionsForFocused = listbox.getPTOptions(opts[1], {}, 1, 'option');
                ...
                const ptOptionsForNonFocused = listbox.getPTOptions(opts[0], {}, 0, 'option');
            ...
            it('should export combined context states via getPTOptions', async () => {
                ...
                const ptSelected = listbox.getPTOptions(opts[0], {}, 0, 'option');
                ...
                const ptDisabled = listbox.getPTOptions(opts[1], {}, 1, 'option');
                ...
                const ptFocused = listbox.getPTOptions(opts[2], {}, 2, 'option');
            ...
            it('should apply PT to optionGroup when using grouped options', async () => {
                ...
                ptFixture.componentRef.setInput('options', groupOpts);
                ptFixture.componentRef.setInput('pt', {
