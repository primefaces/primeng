...
describe('Listbox', () => {
    ...
    beforeEach(async () => {
        await TestBed.configureTestingModule({
            imports: [Listbox, FormsModule, ReactiveFormsModule, CommonModule, NoopAnimationsModule],
...
// Template test component using pTemplate directive
@Component({
    standalone: false,
    template: `
        <p-listbox [(ngModel)]="selectedValues" [options]="items" [optionLabel]="'label'" [optionValue]="'value'" [multiple]="true" [filter]="true" [checkbox]="true" [group]="true" [showToggleAll]="true" [virtualScroll]="true">
            ...
            <ng-template pTemplate="item" let-option let-selected="selected" let-index="index">
                <div class="custom-item" data-testid="ptemplate-item">
            ...
            <ng-template pTemplate="group" let-group let-index="index">
                <div class="custom-group" data-testid="ptemplate-group">
...
// Template test component using #template references
@Component({
    standalone: false,
    template: `
        <p-listbox [(ngModel)]="selectedValues" [options]="items" [optionLabel]="'label'" [optionValue]="'value'" [multiple]="true" [filter]="true" [checkbox]="true" [group]="true" [showToggleAll]="true" [virtualScroll]="true">
            ...
            <ng-template #item let-option let-selected="selected" let-index="index">
                <div class="custom-item" data-testid="ref-item">
                    <span class="item-label">{{ option.label }}</span>
                    <span class="item-value">{{ option.value }}</span>
                    <span class="item-index">{{ index }}</span>
                    <span class="item-selected">{{ selected }}</span>
            ...
            <ng-template #group let-group let-index="index">
                <div class="custom-group" data-testid="ref-group">
                    <span class="group-label">{{ group.label }}</span>
                    <span class="group-index">{{ index }}</span>
                </div>
            </ng-template>
...
describe('Listbox pTemplate Tests', () => {
    ...
    beforeEach(async () => {
        await TestBed.configureTestingModule({
            imports: [Listbox, FormsModule, CommonModule, NoopAnimationsModule],
