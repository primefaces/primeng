...
const classes = {
    root: ({ instance }) => [
        'p-button p-component',
        {
            ...
            'p-button-text': instance.text || instance.variant === 'text' || instance.buttonProps?.variant === 'text',
            'p-button-outlined': instance.outlined || instance.variant === 'outlined' || instance.buttonProps?.variant === 'outlined',
