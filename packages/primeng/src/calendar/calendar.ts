...
@Component({
    selector: 'p-calendar',
    imports: [NgTemplateOutlet, NgClass, NgStyle, Button, Ripple, ChevronLeftIcon, ChevronRightIcon, ChevronUpIcon, ChevronDownIcon, TimesIcon, CalendarIcon, AutoFocus, InputText, SharedModule],
    template: `
                                                            ...
                                                            >
                                                                @if (date.otherMonth ? showOtherMonths : true) {
                                                                    <span
                                                                        ...
                                                                        pRipple
                                                                    >
                                                                        @if (!disabledDate && (date.selectable || !disabledDate)) {
                                                                            {{ date.day }}
                                                                        }
                                                                        @if (date.selectable || !disabledDate) {
...
export class Calendar extends BaseComponent implements OnInit, OnDestroy, ControlValueAccessor {
     ...
     * @group Templates
     */
    @ContentChild('disabledDate') disabledDate: Nullable<TemplateRef<any>>;

    /**
     * Custom template for decade view.
     * @group Templates
     */
    @ContentChild('decade') decade: Nullable<TemplateRef<any>>;
