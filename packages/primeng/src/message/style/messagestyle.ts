...
const classes = {
    root: ({ instance }) => ['p-message p-component p-message-' + instance.severity, 'p-message-' + instance.variant, instance.styleClass, { 'p-message-sm': instance.size === 'small', 'p-message-lg': instance.size === 'large' }],
