...
describe('FileUpload', () => {
    ...
    describe('File Selection Events', () => {
        it('should emit onSelect event when files are selected', async () => {
            ...
            component.onFileSelect(event as unknown as Event);
            await fixture.whenStable();
    ...
    describe('Drag and Drop', () => {
        ...
        it('should handle drag leave event', () => {
            fixture.componentRef.setInput('disabled', false);
            component.dragHighlight.set(true);
        ...
        it('should handle drop event', async () => {
            ...
            expect((dropEvent as any).stopPropagation).toHaveBeenCalled();
            expect((dropEvent as any).preventDefault).toHaveBeenCalled();
    ...
    describe('Helper Methods', () => {
        ...
        it('should check if has uploaded files', () => {
            ...
            component.uploadedFiles.set([new File(['test'], 'test.txt', { type: 'text/plain' })]);
    ...
    describe('Edge Cases', () => {
        ...
        it('should handle null/undefined values gracefully', () => {
            fixture.componentRef.setInput('accept', undefined);
            fixture.componentRef.setInput('maxFileSize', undefined);
            fixture.componentRef.setInput('fileLimit', undefined);
            fixture.detectChanges();
    ...
    describe('Comprehensive Context Object Testing', () => {
        ...
        it('should provide correct content context objects', async () => {
            ...
            if (fileUpload) {
                // Add test data
                fileUpload.files = [new File(['test'], 'test.txt', { type: 'text/plain' })];
                fileUpload.uploadedFiles.set([new File(['uploaded'], 'uploaded.txt', { type: 'text/plain' })]);
                fileUpload.progress.set(75);
                fileUpload.msgs.set([{ severity: 'info', text: 'Test message' }]);
            }
...
describe('FileUpload CSS Classes and Styling', () => {
    ...
    it('should apply custom styles', () => {
        ...
        const styleValue = component.style();
        if (styleValue) {
            Object.keys(styleValue).forEach((key) => {
                element.style[key] = styleValue[key];
            });
        }
    ...
    describe('Mixed Template Usage', () => {
        ...
        it('should handle mixed template interactions', async () => {
            ...
            if (fileUpload) {
                ...
                fileUpload.files = testFiles;
                fileUpload.uploadedFiles.set([new File(['uploaded'], 'completed.txt', { type: 'text/plain' })]);
                fileUpload.progress.set(45);
...
describe('FileUpload Input Properties - Static Values', () => {
    ...
    describe('Object Input Properties', () => {
        it('should set and get style property', () => {
            ...
            fixture.componentRef.setInput('style', null);
            fixture.detectChanges();
