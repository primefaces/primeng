...
import type { InputColorSliderThumbPassThrough } from 'primeng/types/inputcolor';
...
export class InputColorSliderThumb extends BaseComponent<InputColorSliderThumbPassThrough> {
