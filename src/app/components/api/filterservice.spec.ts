...
describe('FilterService Suite', () => {
    ...
    describe('when using array of objects', () => {
        const data: any = [
            {
                brand: 'VW',
                year: 2012,
        ...
        it('Should filter by startsWith', () => {
            let filteredValue = filterService.filter(
                data,
                ['brand'],
                'f',
                'startsWith'
            ...
            filteredValue = filterService.filter(
                data,
                ['brand'],
                '',
                'startsWith'
        ...
        it('Should filter by lt', () => {
            let filteredValue = filterService.filter(
                timeData,
                ['date'],
                'Tue Aug 05 2019 00:00:00 GMT+0300 (GMT+03:00)',
                'lt'
            );
            expect(filteredValue.length).toEqual(1);
    ...
    describe('When using array of strings', () => {
        const data = [
            'VW',
            'Audi',
            'Renault',
