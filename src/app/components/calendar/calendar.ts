                 ...
                 *ngIf="inline || overlayVisible"
                 ...
                 [ngClass]="
                    {'ui-datepicker ui-widget ui-widget-content ui-helper-clearfix ui-corner-all': true,
                     'ui-datepicker-inline':inline, 'ui-shadow':!inline, 'ui-state-disabled':disabled,
                     'ui-datepicker-timeonly':timeOnly,'ui-datepicker-multiple-month': this.numberOfMonths > 1,
                     'ui-datepicker-monthpicker': (view === 'month'), 'ui-datepicker-touch-ui': touchUI
                    }"
                 [@overlayAnimation]="
                    touchUI
                    ? {
                        ...
                        <div class="ui-datepicker-header ui-widget-header ui-helper-clearfix ui-corner-all">
                            ...
                            <div class="ui-datepicker-title">
                                ...
                                <select tabindex="0"
                                    ...
                                    <option *ngFor="let monthName of locale.monthNames;let i = index"
                                            [value]="i"
                ...
                <div class="ui-timepicker ui-widget-header ui-corner-all" *ngIf="showTime||timeOnly">
                    ...
                    <div class="ui-minute-picker">
                        ...
                        <span
                            ...
                            }">0</span><span>{{currentMinute}}</span>
                        <a tabindex="0"
                           (keydown)="onContainerButtonKeydown($event)"
                    ...
                    <div *ngIf="showSeconds"
                        ...
                        }">0</span><span>{{currentSecond}}</span>
                        <a tabindex="0" (keydown)="onContainerButtonKeydown($event)"
                    ...
                    <div *ngIf="hourFormat=='12'"
                         class="ui-ampm-picker">
                        <a tabindex="0"
                           (keydown)="onContainerButtonKeydown($event)"
...
export class Calendar implements OnInit, OnDestroy, AfterContentInit, ControlValueAccessor {
    ...
    /**
     * Generation months of year logic,
     * which executes during the minDate, maxDate, disableDates and disableDays input changes
     */
    private monthsCreationLogic(): void {
