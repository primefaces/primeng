    ...
    template: `<p-pickList [source]="sourceCars" [target]="targetCars">
        <ng-template let-car pTemplate="item">
            <div class="p-clearfix">
                <img
                    src="assets/showcase/images/demo/car/{{ car.brand }}.png"
...
class TestStringPickListComponent {
    sourceCars = [
        'VW',
        'Audi',
        'Renault',
...
describe('PickList', () => {
    describe('when using array of objects', () => {
        ...
        it('should created by default', () => {
            ...
            const controlEls = fixture.debugElement.queryAll(
                By.css('.p-picklist-buttons')
            );
        ...
        it('should change style and styleClass', () => {
            ...
            const picklistEl = fixture.debugElement.query(By.css('div'));
            expect(picklistEl.nativeElement.className).toContain(
                'Primeng ROCKS!'
            );
        ...
        it('should show sourceHeader and targetHeader', () => {
            ...
            const headerEls = fixture.debugElement.queryAll(
                By.css('.p-picklist-header')
            );
        ...
        it('should show filter input', () => {
            ...
            picklist.cd.detectChanges();
            const filterContainers = fixture.debugElement.queryAll(
                By.css('.p-picklist-filter-container')
            );
        ...
        it('should filtered source', () => {
            ...
            const sourceListItems = fixture.debugElement
        ...
        it('should filtered target', () => {
            ...
            picklist.cd.detectChanges();
            const controlAllRightButton = fixture.debugElement
                .query(By.css('.p-picklist-transfer-buttons'))
                .queryAll(By.css('button'))[1];
            controlAllRightButton.nativeElement.click();
            fixture.detectChanges();

            const targetFilterEl = fixture.debugElement.queryAll(
                By.css('input')
            )[1];
            ...
            picklist.cd.detectChanges();
            const targetListItems = fixture.debugElement
        ...
        it('should use input placeholders', () => {
            ...
            picklist.cd.detectChanges();
            const headerEls = fixture.debugElement.queryAll(
                By.css('.p-picklist-filter')
            );
            expect(headerEls.length).toEqual(2);
            expect(
                headerEls[0].query(By.css('input')).nativeElement.placeholder
            ).toEqual('Primeng');
            expect(
                headerEls[1].query(By.css('input')).nativeElement.placeholder
            ).toEqual('ROCKS!');
        });
        ...
        it('should show items', () => {
            ...
            const sourceListItems = fixture.debugElement
                .query(By.css('.p-picklist-source'))
                .queryAll(By.css('.p-picklist-item'));
            const targetListItems = fixture.debugElement
                .query(By.css('.p-picklist-target'))
                .queryAll(By.css('.p-picklist-item'));
        ...
        it('should not show controls', () => {
            ...
            const sourceControlsEl = fixture.debugElement.query(
                By.css('.p-picklist-source-controls')
            );
            const targetControlsEl = fixture.debugElement.query(
                By.css('.p-picklist-target-controls')
            );
        ...
        it('should select item', () => {
            ...
            expect(sourceListItems[0].nativeElement.className).toContain(
                'p-highlight'
            );
        ...
        it('should not select item', () => {
            ...
            expect(onItemClickSpy).toHaveBeenCalled();
            expect(sourceListItems[0].nativeElement.className).not.toContain(
                'p-highlight'
            );
        ...
        it('should unselect item', () => {
            ...
            picklist.onItemClick(
                event,
                picklist.source[0],
                picklist.selectedItemsSource,
                callback
            );
            fixture.detectChanges();
        ...
        it('should call moveUp', () => {
            ...
            const sourceListItems = fixture.debugElement
                .query(By.css('.p-picklist-source-wrapper'))
                .queryAll(By.css('.p-picklist-item'));
            const sourceControlUpButton = fixture.debugElement
                .query(By.css('.p-picklist-source-controls'))
            ...
            expect(
                sourceListItemsAfterChange[2].nativeElement.className
            ).toContain('p-highlight');
            expect(
                sourceListItemsAfterChange[2].nativeElement.textContent
            ).toContain('BMW');
            expect(
                sourceListItemsAfterChange[3].nativeElement.textContent
            ).toContain('Renault');
        });
        ...
        it('should call moveDown', () => {
            ...
            const sourceListItems = fixture.debugElement
                .query(By.css('.p-picklist-source-wrapper'))
                .queryAll(By.css('.p-picklist-item'));
            const sourceControlDownButton = fixture.debugElement
                .query(By.css('.p-picklist-source-controls'))
            ...
            expect(
                sourceListItemsAfterChange[4].nativeElement.className
            ).toContain('p-highlight');
            expect(
                sourceListItemsAfterChange[4].nativeElement.textContent
            ).toContain('BMW');
            expect(
                sourceListItemsAfterChange[3].nativeElement.textContent
            ).toContain('Mercedes');
        ...
        it('should call movetop', () => {
            ...
            const sourceListItems = fixture.debugElement
                .query(By.css('.p-picklist-source-wrapper'))
                .queryAll(By.css('.p-picklist-item'));
            const sourceControlTopButton = fixture.debugElement
                .query(By.css('.p-picklist-source-controls'))
                .queryAll(By.css('button'))[1];
            sourceListItems[3].nativeElement.click();
            fixture.detectChanges();
            ...
            expect(
                sourceListItemsAfterChange[0].nativeElement.className
            ).toContain('p-highlight');
            expect(
                sourceListItemsAfterChange[0].nativeElement.textContent
            ).toContain('BMW');
            expect(
                sourceListItemsAfterChange[3].nativeElement.textContent
            ).toContain('Renault');
        ...
        it('should call moveBottom', () => {
            ...
            const sourceListItems = fixture.debugElement
                .query(By.css('.p-picklist-source-wrapper'))
                .queryAll(By.css('.p-picklist-item'));
            const sourceControlBottomButton = fixture.debugElement
                .query(By.css('.p-picklist-source-controls'))
                .queryAll(By.css('button'))[3];
            sourceListItems[3].nativeElement.click();
            fixture.detectChanges();
            ...
            expect(
                sourceListItemsAfterChange[9].nativeElement.className
            ).toContain('p-highlight');
            expect(
                sourceListItemsAfterChange[9].nativeElement.textContent
            ).toContain('BMW');
            expect(
                sourceListItemsAfterChange[3].nativeElement.textContent
            ).toContain('Mercedes');
        ...
        it('should call moveRight', () => {
            ...
            const sourceListItems = fixture.debugElement
                .query(By.css('.p-picklist-source-wrapper'))
                .queryAll(By.css('.p-picklist-item'));
            const controlRightButton = fixture.debugElement
                .query(By.css('.p-picklist-transfer-buttons'))
                .queryAll(By.css('button'))[0];
            sourceListItems[3].nativeElement.click();
            fixture.detectChanges();
            ...
            expect(
                targetListItemsAfterChange[0].nativeElement.textContent
            ).toContain('BMW');
        ...
        it('should call moveLeft', () => {
            ...
            const controlRightButton = fixture.debugElement
                .query(By.css('.p-picklist-transfer-buttons'))
                .queryAll(By.css('button'))[0];
            const controlLeftButton = fixture.debugElement
                .query(By.css('.p-picklist-transfer-buttons'))
                .queryAll(By.css('button'))[2];
            sourceListItems[3].nativeElement.click();
            fixture.detectChanges();
        ...
        it('should call moveAllLeft', () => {
            ...
            const controlAllRightButton = fixture.debugElement
                .query(By.css('.p-picklist-transfer-buttons'))
                .queryAll(By.css('button'))[1];
            const controlAllLeftButton = fixture.debugElement
                .query(By.css('.p-picklist-transfer-buttons'))
                .queryAll(By.css('button'))[3];
            fixture.detectChanges();
        ...
        it('should listen onTargetReorder', () => {
            ...
            const sourceListItems = fixture.debugElement
                ...
                .queryAll(By.css('.p-picklist-item'));
            const sourceControlUpButton = fixture.debugElement
                .query(By.css('.p-picklist-target-controls'))
                .queryAll(By.css('button'))[0];
            sourceListItems[3].nativeElement.click();
            fixture.detectChanges();
        ...
        it('should send item to right and after send item to left', () => {
            ...
            const onSourceItemDblClickSpy = spyOn(
                picklist,
                'onSourceItemDblClick'
            ).and.callThrough();
            const onTargetItemDblClickSpy = spyOn(
                picklist,
            ...
            const sourceListItems = fixture.debugElement
                ...
                .queryAll(By.css('.p-picklist-item'));
            sourceListItems[0].nativeElement.click();
            sourceListItems[0].nativeElement.dispatchEvent(
                new Event('dblclick')
            );
            fixture.detectChanges();
            ...
            targetListItems[0].nativeElement.click();
            targetListItems[0].nativeElement.dispatchEvent(
                new Event('dblclick')
            );
            fixture.detectChanges();
    ...
    describe('when using array of strings', () => {
        let picklist: PickList;
        let fixture: ComponentFixture<TestStringPickListComponent>;
        let testComponent: TestStringPickListComponent;

        beforeEach(() => {
            TestBed.configureTestingModule({
                imports: [NoopAnimationsModule, PickListModule],
                declarations: [PickList, TestStringPickListComponent],
            });

            fixture = TestBed.createComponent(TestStringPickListComponent);
            testComponent = fixture.componentInstance;
            picklist = fixture.debugElement.children[0].componentInstance;
        });
        ...
        it('should filtered source', () => {
            ...
            const sourceListItems = fixture.debugElement
                ...
                .queryAll(By.css('.p-picklist-item'));
            expect(picklist.visibleOptionsSource.length).toEqual(2);
            expect(picklist.visibleOptionsSource[0]).toEqual('VW');
            expect(picklist.visibleOptionsSource[1]).toEqual('Volvo');
            expect(sourceListItems.length).toEqual(2);
        });
        ...
        it('should filtered target', () => {
            ...
            const targetListItems = fixture.debugElement
                ...
                .queryAll(By.css('.p-picklist-item'));
            expect(picklist.visibleOptionsTarget.length).toEqual(2);
            expect(picklist.visibleOptionsTarget[0]).toEqual('VW');
            expect(picklist.visibleOptionsTarget[1]).toEqual('Volvo');
            expect(targetListItems.length).toEqual(2);
        });
        ...
        it('should select item', () => {
            ...
            expect(picklist.selectedItemsSource.length).toEqual(1);
            expect(picklist.selectedItemsSource[0]).toEqual('VW');
        });
        ...
        it('should call moveRight', () => {
            ...
            expect(targetListItemsAfterChange.length).toEqual(1);
            expect(picklist.target.length).toEqual(1);
            expect(picklist.target[0]).toEqual('BMW');
        });
        ...
        it('should listen onSourceSelect', () => {
            ...
            expect(data).toBeTruthy();
            expect(data.items[0]).toEqual('VW');
        });
        ...
        it('should listen onSourceReorder', () => {
            ...
            expect(data).toBeTruthy();
            expect(data.items[0]).toEqual('BMW');
        });
        ...
        it('should change focused item with up and down arrows', () => {
            ...
            expect(picklist.selectedItemsSource.length).toEqual(1);
            expect(picklist.selectedItemsSource[0]).toBe('VW');
            const keydownEvent: any = document.createEvent('CustomEvent');
            keydownEvent.which = 40;
            keydownEvent.initEvent('keydown', true, true);
            items[0].nativeElement.dispatchEvent(keydownEvent);
            ...
            expect(picklist.selectedItemsSource[0]).toBe('Audi');
        });
    });
});
