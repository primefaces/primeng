...
var AccordionTab = /** @class */ (function () {
    ...
    AccordionTab.prototype.toggle = function (event) {
        ...
        if (this.selected) {
            ...
            this.selected = true;
            if (this.accordion.disableClickEvent || this.accordion.__disableClickEvent || this.__disableClickEvent) {
                this.selected = false;
            }
    ...
    Object.defineProperty(AccordionTab.prototype, "disableClickEvent", {
        get: function () {
            return this.accordion.disableClickEvent;
        },
        enumerable: true,
        configurable: true
    });
...
var Accordion = /** @class */ (function () {
    ...
    __decorate([
        core_1.Input(),
        __metadata("design:type", Boolean)
    ], Accordion.prototype, "disableClickEvent", void 0);
    __decorate([
