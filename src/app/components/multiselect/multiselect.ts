import {NgModule,Component,ElementRef,OnInit,AfterViewInit,AfterContentInit,AfterViewChecked,DoCheck,OnDestroy,Input,Output,Renderer2,EventEmitter,ContentChildren,QueryList,IterableDiffers,forwardRef,ViewChild,TemplateRef} from '@angular/core';
