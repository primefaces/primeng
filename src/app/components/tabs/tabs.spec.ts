...
//             declarations: [Tabs, TabPanel, TestTabsComponent],
//         }).compileComponents();

//         fixture = TestBed.createComponent(TestTabsComponent);
//         tabview = fixture.debugElement.children[0].componentInstance;
//         firstTabPanel = fixture.debugElement.queryAll(By.css('p-tabs'))[0].componentInstance;
//         secondTabPanel = fixture.debugElement.queryAll(By.css('p-tabs'))[1].componentInstance;
//         thirdTabPanel = fixture.debugElement.queryAll(By.css('p-tabs'))[2].componentInstance;
