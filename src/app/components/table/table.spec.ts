...
import { ContextMenu, ContextMenuModule } from '@alamote/primeng/contextmenu';
                ...
                <tr>
                    <td [attr.colspan]="columns.length + 1">
                        <div class="p-grid p-fluid expandedRow" style="font-size:16px;padding:20px">
                            <div class="p-col-12 p-md-3" style="text-align:center"></div>
                            <div class="p-col-12 p-md-9">
                                <div class="p-grid">
                                    <div class="p-col-12"><b>Vin:</b> {{ rowData.vin }}</div>
                                    <div class="p-col-12"><b>Year:</b> {{ rowData.year }}</div>
                                    <div class="p-col-12"><b>Brand:</b> {{ rowData.brand }}</div>
                                    <div class="p-col-12"><b>Color:</b> {{ rowData.color }}</div>
                                </div>
                            </div>
                        </div>
                    </td>
