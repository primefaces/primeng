            ...
            >
                <tr>
                    <td [attr.colspan]="columns.length + 1">
                        <div
                            class="ui-g ui-fluid expandedRow"
...
describe('Table', () => {
    ...
    beforeEach(() => {
        ...
        basicSelectionTable =
            fixture.debugElement.children[3].componentInstance;
        radioSelectionTable =
            fixture.debugElement.children[4].componentInstance;
        checkboxSelectionTable =
            fixture.debugElement.children[5].componentInstance;
    ...
    it('should display 10 rows', () => {
        ...
        const tableEl = fixture.debugElement.query(By.css('div'));
        const bodyRows = tableEl
            .query(By.css('.ui-table-tbody'))
            .queryAll(By.css('tr'));
    ...
    it('should use paginator and list 5 elements', () => {
        ...
        const pageTwoEl = fixture.debugElement
            .query(By.css('p-paginator'))
            .query(By.css('.ui-paginator-pages')).children[1];
    ...
    it('should use basic sort', () => {
        ...
        const brandSortEl = fixture.debugElement.query(
            By.css('.sortableColumn')
        );
        brandSortEl.nativeElement.click();
        fixture.detectChanges();

        const firstEl = fixture.debugElement
            .query(By.css('.sortTable'))
            .query(By.css('.ui-table-tbody'))
            .query(By.css('td'));
    ...
    it('should use multiple sort', fakeAsync(() => {
        ...
        const yearSortEl = fixture.debugElement.queryAll(
            By.css('.sortableColumn')
        )[1];
        const colorSortEl = fixture.debugElement.queryAll(
            By.css('.sortableColumn')
        )[3];
        ...
        const firstRow = fixture.debugElement
            .query(By.css('.sortTable'))
            .query(By.css('.ui-table-tbody'))
            .query(By.css('tr'));
    ...
    it('should use custom sort', () => {
        ...
        sortTable.sortFunction.subscribe(event =>
            testComponent.customSort(event)
        );
        fixture.detectChanges();
    ...
    it('should select single item and unselect when another item select and self click', () => {
        ...
        const selectableRows = fixture.debugElement.queryAll(
            By.css('.selectableRow')
        );
        ...
        expect(audiEl.nativeElement.className).not.toContain(
            'ui-state-highlight'
        );
    });
    ...
    it('should select range  with shiftKey selection', () => {
        ...
        expect(basicSelectionTable.rangeRowIndex).toEqual(
            basicSelectionTable.anchorRowIndex
        );
    ...
    it('should select with radioButton', () => {
        ...
        expect(
            vwRadioEl.query(By.css('.ui-radiobutton-box')).nativeElement
                .className
        ).toContain('ui-state-focus');
        vwRadioEl
            .query(By.css('input'))
    ...
    it('should select with checkbox and unselect when self click', () => {
        ...
        const checkboxRows = fixture.debugElement.queryAll(
            By.css('.rowCheckbox')
        );
        ...
        expect(
            vwCheckboxEl.query(By.css('.ui-chkbox-box')).nativeElement.className
        ).toContain('ui-state-focus');
        vwCheckboxEl
            .query(By.css('input'))
            .nativeElement.dispatchEvent(new Event('blur'));
    ...
    it('should select all items and unselect all item with header checkbox', () => {
        ...
        const vwCheckboxEl = checkboxRows[0].query(By.css('div'));
        const headerCheckbox = fixture.debugElement
            .query(By.css('.headerCheckbox'))
            .query(By.css('div'));
        headerCheckbox
            .query(By.css('input'))
            .nativeElement.dispatchEvent(new Event('focus'));
        ...
        expect(
            headerCheckbox.query(By.css('.ui-chkbox-box')).nativeElement
                .className
        ).toContain('ui-state-focus');
    ...
    it('should headerCheckbox changing by filtering', fakeAsync(() => {
        ...
        const rowCheckboxs = fixture.debugElement.queryAll(
            By.css('.rowCheckbox')
        );
        ...
        expect(
            fixture.debugElement
                .query(By.css('.headerCheckbox'))
                .componentInstance.isAllFilteredValuesChecked()
        ).toEqual(true);
    ...
    it('should open cell', () => {
        ...
        const cell = fixture.debugElement.query(By.css('.ui-editable-column'));
    ...
    it('should close cell', () => {
        ...
        cell.triggerEventHandler('keydown.enter', {});
        fixture.detectChanges();
        ...
        expect(editableTable.editingCell).toBeTruthy();
        cell.triggerEventHandler('keydown.escape', {});
        fixture.detectChanges();
    ...
    it('should open next cell', () => {
        ...
        const cellEls = fixture.debugElement.queryAll(
            By.css('.ui-editable-column')
        );
        ...
        expect(editableTable.editingCell).toBeTruthy();
        cell.triggerEventHandler('keydown.tab', {
            target: cell.children[0].children[0].nativeElement,
            preventDefault() {}
        });
        fixture.detectChanges();
    ...
    it('should open prev cell', () => {
        ...
        const cell = cellEls[1];
        cell.nativeElement.click();
        fixture.detectChanges();

        expect(editableTable.editingCell).toBeTruthy();
        cell.triggerEventHandler('keydown.shift.tab', {
            target: cell.children[0].children[0].nativeElement,
            shiftKey: true,
            preventDefault() {}
        });
    ...
    it('should open expansion', () => {
        ...
        const rowExpansionTableEl = fixture.debugElement.query(
            By.css('.rowExpansionTable')
        );
        const togglerEls = fixture.debugElement.queryAll(
            By.css('.rowExpansionToggler')
        );
        ...
        const expandedRow = fixture.debugElement.query(By.css('.expandedRow'));
    ...
    it('should call resize (fit)', () => {
        ...
        const resizerEls = document.getElementsByClassName('ui-column-resizer');
        const defaultWidth =
            resizerEls[0].parentElement.parentElement.clientWidth;
        const onColumnResizeBeginSpy = spyOn(
            colResizeTable,
            'onColumnResizeBegin'
        ).and.callThrough();
        const event: any = document.createEvent('CustomEvent');
        ...
        const onColumnResizeEndSpy = spyOn(
            colResizeTable,
            'onColumnResizeEnd'
        ).and.callThrough();
        ...
        expect(resizerEls[0].parentElement.clientWidth).toEqual(
            firstWidth - 30
        );
        expect(resizerEls[0].parentElement.clientWidth).not.toEqual(firstWidth);
        expect(defaultWidth).toEqual(
            resizerEls[0].parentElement.parentElement.clientWidth
        );
    });
    ...
    it('should call resize (expand)', () => {
        ...
        expect(resizerEls[0].parentElement.clientWidth).not.toEqual(firstWidth);
        expect(defaultWidth).not.toEqual(
            resizerEls[0].parentElement.parentElement.clientWidth
        );
        expect(defaultWidth).toEqual(
            resizerEls[0].parentElement.parentElement.clientWidth + 30
        );
    });
    ...
    it('should reorder column (dropPosition -1)', () => {
        ...
        dragEvent.initEvent('dragenter', true, true);
        dragEvent.pageX =
            reorableHeaderEls[3].nativeElement.clientWidth * 2 + 1;
        ...
        expect(reorableHeaderEls[2].nativeElement.textContent).toEqual(
            ' Brand '
        );
    });
    ...
    it('should reorder column (dropPosition +1)', () => {
        ...
        dragEvent.initEvent('dragenter', true, true);
        dragEvent.pageX =
            reorableHeaderEls[3].nativeElement.clientWidth * 3 + 1;
        reorableHeaderEls[3].nativeElement.dispatchEvent(dragEvent);
        fixture.detectChanges();
        ...
        expect(reorableHeaderEls[3].nativeElement.textContent).toEqual(
            ' Brand '
        );
    });
    ...
    it('should reorder row (top of the dropped row)', () => {
        ...
        const handleEls = reorderableTableEl.queryAll(
            By.css('.ui-table-reorderablerow-handle')
        );
        expect(reorderableRowEls[1].nativeElement.draggable).toBeFalsy();
        expect(
            reorderableRowEls[1].children[1].nativeElement.textContent
        ).toEqual(' VW ');
        reorderableRowEls[1].nativeElement.classList.add(
            'ui-table-reorderablerow-handle'
        );
        reorderableRowEls[1].nativeElement.dispatchEvent(
            new Event('mousedown')
        );
        fixture.detectChanges();

        expect(reorderableRowEls[1].nativeElement.draggable).toBeTruthy();
        reorderableRowEls[1].nativeElement.classList.remove(
            'ui-table-reorderablerow-handle'
        );
        const onRowDragStartSpy = spyOn(
            reorderableTable,
            'onRowDragStart'
        ).and.callThrough();
        const dragEvent: any = document.createEvent('CustomEvent');
        ...
        dragEvent.pageY =
            reorderableRowEls[3].nativeElement.clientWidth * 3 + 1;
        const onRowDragOverSpy = spyOn(
            reorderableTable,
            'onRowDragOver'
        ).and.callThrough();
        ...
        expect(reorderableRowEls[3].nativeElement.classList).toContain(
            'ui-table-dragpoint-bottom'
        );
        expect(reorderableTable.droppedRowIndex).toEqual(3);
        const onRowDropSpy = spyOn(
            reorderableTable,
            'onRowDrop'
        ).and.callThrough();
        const onRowDragEndSpy = spyOn(
            reorderableTable,
            'onRowDragEnd'
        ).and.callThrough();
        const onRowDragLeaveSpy = spyOn(
            reorderableTable,
            'onRowDragLeave'
        ).and.callThrough();
        ...
        expect(
            reorderableRowEls[2].children[1].nativeElement.textContent
        ).toEqual(' Renault ');
        expect(
            reorderableRowEls[3].children[1].nativeElement.textContent
        ).toEqual(' VW ');
    ...
    it('should call saveState and clearState (session)', () => {
        ...
        let state = JSON.parse(
            stateTable.getStorage().getItem(stateTable.stateKey)
        );
