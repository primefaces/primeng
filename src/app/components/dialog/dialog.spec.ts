...
describe('Dialog', () => {
    ...
    it('should change location with drag actions', fakeAsync(() => {
        ...
        tick(300);
        const firstLeft = dialog.container.style.left;
        const firstTop = dialog.container.style.top;
        const event = {
            pageX: 500,
            pageY: 500,
    ...
    it('should change location with resize actions', fakeAsync(() => {
        ...
        tick(300);
        const firstWidth = dialog.container.offsetWidth;
        const firstHeight = dialog.container.offsetHeight;
        const event = {
            pageX: 500,
            pageY: 500
        };
