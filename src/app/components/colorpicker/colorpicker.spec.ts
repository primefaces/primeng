...
describe("ColorPicker", () => {
    ...
    it("should created by default", () => {
        ...
        const colorPickerEl = fixture.debugElement.query(
            By.css(".p-colorpicker")
        );
    ...
    it("should select color", () => {
        ...
        const colorSelectorEl = fixture.debugElement.query(
            By.css(".p-colorpicker-color-selector")
        );
        colorSelectorEl.triggerEventHandler("mousedown", {
            pageX: 100,
            pageY: 120,
        });
        fixture.detectChanges();
    ...
    it("should select hue", () => {
        ...
        const hueSelectorEl = fixture.debugElement.query(
            By.css(".p-colorpicker-hue")
        );
        hueSelectorEl.triggerEventHandler("mousedown", {
            pageX: 20,
            pageY: 25,
        });
        fixture.detectChanges();
    ...
    it("should close when inputclick", () => {
        ...
        let selectorEl = fixture.debugElement.query(
            By.css(".p-colorpicker-panel")
        );
        expect(selectorEl).toBeTruthy();
        inputEl.nativeElement.click();
    ...
    it("should correctly calculate alpha values", () => {
        colorpicker.useAlpha = true;
        colorpicker.format = "hex";
        colorpicker.writeValue("#1976D280");

        expect(colorpicker.value.a).toBe(0.5);

        colorpicker.format = "rgb";
        colorpicker.writeValue({
            r: 255,
            g: 0,
            b: 0,
            a: 0.75,
        ...
        expect(colorpicker.value.a).toBe(0.75);
        ...
        expect(colorpicker.value.a).toBe(0.25);
    });
});
