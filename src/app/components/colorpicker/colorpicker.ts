                    ...
                    <div *ngIf="showColorInputs" class="picker-inputs-area">
                        ...
                        <div [ngSwitch]="currentColorType">
                            ...
                            <div *ngSwitchCase="ColorType.RGB" class="picker-inputs picker-inputs-multiple">
                                <input type="text" placeholder="R" class="p-inputtext" [value]="currentRGBCode.r" (blur)="updateColorPickerRGB('R', $event)" (keydown.enter)="updateColorPickerRGB('R', $event)" />
                                <input type="text" placeholder="G" class="p-inputtext" [value]="currentRGBCode.g" (blur)="updateColorPickerRGB('G', $event)" (keydown.enter)="updateColorPickerRGB('G', $event)" />
                                <input type="text" placeholder="B" class="p-inputtext" [value]="currentRGBCode.b" (blur)="updateColorPickerRGB('B', $event)" (keydown.enter)="updateColorPickerRGB('B', $event)" />
                            </div>
                            <div *ngSwitchCase="ColorType.HSB" class="picker-inputs picker-inputs-multiple">
                                <input type="text" placeholder="H" (blur)="updateColorPickerHSB('H', $event)" (keydown.enter)="updateColorPickerHSB('H', $event)" class="p-inputtext" [value]="currentHSBCode.h" />
                                <input type="text" placeholder="S" (blur)="updateColorPickerHSB('S', $event)" (keydown.enter)="updateColorPickerHSB('S', $event)" class="p-inputtext" [value]="currentHSBCode.s" />
                                <input type="text" placeholder="B" (blur)="updateColorPickerHSB('B', $event)" (keydown.enter)="updateColorPickerHSB('B', $event)" class="p-inputtext" [value]="currentHSBCode.b" />
                            </div>
                        </div>
