...
@Component({
    template: `
        <p-tree></p-tree>
        <p-contextMenu #cm [model]="[]"></p-contextMenu>
        <p-tree class="files" [value]="filesTree7" draggableNodes="true" droppableNodes="true" droppableScope="files"
                draggableScope="server2"></p-tree>
        <p-tree class="server1" [value]="filesTree8" draggableNodes="true" droppableNodes="true" droppableScope="server1"
                draggableScope="files"></p-tree>
        <p-tree class="server2" [value]="filesTree9" draggableNodes="true" droppableNodes="true" droppableScope="server2"
                draggableScope="server1"></p-tree>
    `
})
class TestTreeComponent implements OnInit {
    ...
    ngOnInit() {
        this.filesTree7 = getExampleData();
...
describe('Tree', () => {
    ...
    it('should focused with nav keys', () => {
        ...
        firstEl.triggerEventHandler('keydown', {
            which: 40, target: firstEl.nativeElement, preventDefault() {
            }
        });
        fixture.detectChanges();
        ...
        secondEl.triggerEventHandler('keydown', {
            which: 38, target: secondEl.nativeElement, preventDefault() {
            }
        });
        fixture.detectChanges();
        ...
        firstEl.triggerEventHandler('keydown', {
            which: 38, target: firstEl.nativeElement, preventDefault() {
            }
        });
        fixture.detectChanges();
        ...
        expect(focusElement).toEqual(firstNode.nativeElement);
        secondEl.triggerEventHandler('keydown', {
            which: 40, target: secondEl.nativeElement, preventDefault() {
            }
        });
        fixture.detectChanges();

        thirdEl.triggerEventHandler('keydown', {
            which: 40, target: thirdEl.nativeElement, preventDefault() {
            }
        });
        fixture.detectChanges();
    ...
    it('should expand&collapse with right and left key', () => {
        ...
        const firstEl = contentEls[0];
        firstEl.triggerEventHandler('keydown', {
            which: 39, target: firstEl.nativeElement, preventDefault() {
            }
        });
        fixture.detectChanges();
        ...
        expect(documentsNode.node.expanded).toBeTruthy();
        firstEl.triggerEventHandler('keydown', {
            which: 37, target: firstEl.nativeElement, preventDefault() {
            }
        });
        fixture.detectChanges();
        ...
        expect(documentsNode.node.expanded).toBeFalsy();
        firstEl.triggerEventHandler('keydown', {
            which: 13, target: firstEl.nativeElement, preventDefault() {
            }
        });
        fixture.detectChanges();
        ...
        expect(documentsNode.node.expanded).toBeFalsy();
        firstEl.triggerEventHandler('keydown', {
            which: 12, target: firstEl.nativeElement, preventDefault() {
            }
        });
        fixture.detectChanges();
    ...
    it('should select with second click and open the context menu', () => {
        ...
        documentsContentEl.triggerEventHandler('contextmenu', {
            target: documentsContentEl.nativeElement, preventDefault() {
            }
        });
        fixture.detectChanges();
    ...
    it('should be filterable with filterValue attribute', () => {
        tree.filter = true;
        fixture.detectChanges();
    ...
    it('should emit new filter value', () => {
        tree.filter = true;
        fixture.detectChanges();

        tree.filterValueChange.asObservable()
            .subscribe(newFilterValue => expect(newFilterValue).toBe('d'));
    ...
    it('should drop item from files to server2', () => {
        ...
        let dropEvent;
        server2Tree.onNodeDrop.subscribe((event) => {
            dropEvent = event;
        });
        server2TreeEl.triggerEventHandler('drop', {
            preventDefault() {
            }
        });
        server2DropPoints[1].triggerEventHandler('drop', {
            preventDefault() {
            }
        });
        fixture.detectChanges();
    ...
    it('should drop item to inside of node', () => {
        ...
        serverContentEl.triggerEventHandler('dragenter', {dataTransfer: new DataTransfer()});
        serverContentEl.triggerEventHandler('dragover', {
            dataTransfer: new DataTransfer(), preventDefault() {
            }, stopPropagation() {
            }
        });
        let dropEvent;
        ...
        serverContentEl.triggerEventHandler('drop', {
            preventDefault() {
            }, stopPropagation() {
            }
        });
        serverContentEl.triggerEventHandler('dragend', {
            dataTransfer: new DataTransfer(), preventDefault() {
            }, stopPropagation() {
            }
        });
