...
export class UITreeNode implements OnInit {
    ...
    onDropPoint(event: DragEvent, position: number) {
        ...
        if (this.tree.allowDrop(<TreeNode>dragNode, <TreeNode>this.node, dragNodeScope, true) && isValidDropPointIndex) {
    ...
    onDropPointDragEnter(event: Event, position: number) {
        if (this.tree.allowDrop(<TreeNode>this.tree.dragNode, <TreeNode>this.node, this.tree.dragNodeScope, true)) {
...
export class Tree implements OnInit, AfterContentInit, OnChanges, OnDestroy, BlockableUI {
    ...
    allowDrop(dragNode: TreeNode, dropNode: TreeNode<any> | null, dragNodeScope: any, dropPoint: boolean = false): boolean {
        if (!dragNode) {
