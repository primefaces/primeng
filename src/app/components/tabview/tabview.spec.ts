...
@Component({
    template: `<p-tabView>
        <p-tabPanel header="Godfather I" startIcon="pi pi-calendar">
        ...
        <p-tabPanel header="Godfather II" startIcon="pi pi-inbox">
            Francis Ford Coppola's legendary continuation and sequel to his landmark 1972 film, The_Godfather parallels the young Vito Corleone's rise with his son Michael's spiritual fall, deepening The_Godfather's depiction of the dark side of the
            American dream. In the early 1900s, the child Vito flees his Sicilian village for America after the local Mafia kills his family. Vito struggles to make a living, legally or illegally, for his wife and growing brood in Little Italy,
        ...
        <p-tabPanel>
            ...
            <ng-template pTemplate="content">
                After a break of more than 15 years, director Francis Ford Coppola and writer Mario Puzo returned to the well for this third and final story of the fictional Corleone crime family. Two decades have passed, and crime kingpin Michael
...
describe('TabView', () => {
    ...
    it('should change left and right icon', () => {
        ...
        firstTabPanel.startIcon = 'PrimeNg ROCKS!';
        firstTabPanel.endIcon = 'ALWAYS BET ON PRIME';
        fixture.detectChanges();
