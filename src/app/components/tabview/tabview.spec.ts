...
@Component({
    template: `<p-tabView>
        <p-tab-panel header="Godfather I" leftIcon="pi pi-calendar">
        ...
        <p-tab-panel header="Godfather II" leftIcon="pi pi-inbox">
            ...
            Corleone's rise with his son Michael's spiritual fall, deepening The_Godfather's depiction of the dark side of the American
            dream. In the early 1900s, the child Vito flees his Sicilian village for America after the local Mafia kills his family. Vito
            struggles to make a living, legally or illegally, for his wife and growing brood in Little Italy, killing the local Black Hand
        ...
        <p-tab-panel>
            ...
            <ng-template pTemplate="content">
                ...
                and final story of the fictional Corleone crime family. Two decades have passed, and crime kingpin Michael Corleone, now
                divorced from his wife Kay has nearly succeeded in keeping his promise that his family would one day be completely
                legitimate.
            </ng-template>
        </p-tab-panel>
    </p-tabView>`,
...
describe('TabView', () => {
    ...
    it('should change the header', () => {
        ...
        const firstTabViewNavEl =
            fixture.debugElement.children[0].children[0].children[0].children[0].children[0].children[0].nativeElement;
        const secondTabViewNavEl =
            fixture.debugElement.children[0].children[0].children[0].children[0].children[0].children[1].nativeElement;
    ...
    it('should closable and element count should be 2', () => {
        ...
        tabview.cd.detectChanges();
        const firstTabViewNavEl = fixture.debugElement.children[0].children[0].children[0].children[0].query(
            By.css('timesicon'),
        ).nativeElement;
    ...
    it('should open by activeIndex', () => {
        ...
        const secondTabViewNavEl =
            fixture.debugElement.children[0].children[0].children[0].children[0].children[0].children[1].nativeElement;
        const thirdTabViewNavEl =
            fixture.debugElement.children[0].children[0].children[0].children[0].children[0].children[2].nativeElement;
