            ...
            <tr #rowElement *ngIf="!dt.expandableRowGroups||dt.isRowGroupExpanded(rowData)"
                ...
                <ng-template ngFor let-col [ngForOf]="columns" let-colIndex="index">
                    <td #cell *ngIf="!dt.rowGroupMode || (dt.rowGroupMode == 'subheader') ||
                        ...
                        <span class="ui-cell-data" *ngIf="!col.bodyTemplate && !col.expander && !col.selectionMode">
                          <span #uiCellDataTextSpan [ngClass]="dt.ellipsis ? 'ui-ellipsis' : ''" >{{dt.resolveFieldData(rowData,col.field)}}</span>
                          <div [hidden]="!objectUtils.isEllipsisActive(uiCellDataTextSpan)" class="ui-datatable-tooltip ui-tooltip-bottom">
                            <div class="ui-tooltip-arrow"></div>
                            <div class="ui-tooltip-text ui-shadow ui-corner-all">{{dt.resolveFieldData(rowData,col.field)}}</div>
                          </div>
                        </span>
...
export class TableBody {
    ...
    constructor(@Inject(forwardRef(() => DataTable)) public dt:DataTable, public objectUtils: ObjectUtils) {}
