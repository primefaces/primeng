...
describe('Menubar', () => {
	...
	it('should pass wcag20 rules', () => {
		...
		fixture.detectChanges();
		const menuitemEl =  fixture.debugElement.query(By.css('[role="menuitem"]'));
		console.log(menuitemEl.parent);
		expect(menuitemEl.parent.attributes.role).toBe('menu');
	});
});
