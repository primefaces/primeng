...
import { Header, Footer, PrimeTemplate, SharedModule, FilterService, TranslationKeys, PrimeNGConfig } from '@alamote/primeng/api';
import { PaginatorModule } from '@alamote/primeng/paginator';
import { BlockableUI } from '@alamote/primeng/api';
import { Subscription } from 'rxjs';
import { SpinnerIcon } from '@alamote/primeng/icons/spinner';
import { ThLargeIcon } from '@alamote/primeng/icons/thlarge';
import { BarsIcon } from '@alamote/primeng/icons/bars';
