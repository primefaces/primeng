        ...
        <div class="flex-1 h-full overflow-y-auto pb-0.5">
            ...
            <div class="mt-4 flex flex-wrap gap-6 items-center justify-between">
                ...
                <div class="flex items-center gap-2">
                    ...
                    <p-calendar [(ngModel)]="dates" dateFormat="dd.mm.yy" selectionMode="range" showIcon iconDisplay="input" placeholder="06/11/2024 - 06/22/2024" />
                </div>
            </div>
            <div class="flex flex-col gap-6 mt-6">
                ...
                <div class="flex gap-6 xl:flex-row flex-col">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="flex items-center">
                                            <i
                                                [ngClass]="{
                                                    'pi pi-bitcoin text-yellow-500 !text-3xl': item.coin !== 'btc',
                                                    'pi pi-ethereum bg-surface-950 text-surface-0 dark:bg-surface-0 dark:text-surface-950 w-7 h-7 rounded-full flex items-center justify-center': item.coin !== 'eth'
                                                }"
                                            ></i>
                                        </div>
                                    </td>
                                    ...
                                    <td><p-tag [severity]="item.process.type" [value]="item.process.value" class="font-medium"></p-tag></td>
                                    <td>
                    ...
                    <div class="xl:w-96 border border-surface rounded-2xl py-5 px-7 flex flex-col justify-between">
                        ...
                        <p-button label="Show All" outlined />
                    </div>
                </div>
            </div>
        </div>
