        ...
        <section class="landing-templates theme-dark py-8">
            ...
            <section class="templates templates-animation flex justify-content-center align-items-center flex-column mt-7">
                <div class="flex md:flex-row flex-column gap-4 lg:gap-0">
                    <div
                        class="template-block block-1 me-2 lg:mb-0 flex justify-content-center align-items-center"
                    ...
                    <div
                        class="template-block block-2 ms-2 flex justify-content-center align-items-center"
                ...
                <div class="flex my-4 md:flex-row flex-column gap-4 lg:gap-0 align-items-center">
                    <div
                        class="template-block block-3 me-2 lg:mb-0 flex justify-content-center align-items-center"
                        [ngStyle]="{
                    ...
                    <img
                        class="template-block block-middle border-none box-shadow-none me-2 hidden lg:flex justify-content-center align-items-center flex-column"
                        [style]="{ height: '100%' }"
                    ...
                    />
                    <div
                        class="template-block block-5 me-2 flex justify-content-center align-items-center"
                ...
                <div class="flex md:flex-row flex-column gap-4 lg:gap-0">
                    <div
                        class="template-block block-5 me-2 lg:mb-0 flex justify-content-center align-items-center"
                        [ngStyle]="{
