...
import { MenuItem, SelectItem } from 'primengrtl/api';
    ...
    template: `
        <section class="landing-hero py-8 px-5 lg:px-8">
            <div class="flex flex-wrap">
                <div class="w-full xl:w-6 flex flex-column justify-content-center lg:pe-8 align-items-center xl:align-items-stretch">
                    ...
                    <div class="flex align-items-center gap-3">
                        ...
                        <a href="https://github.com/primefaces/primeng" target="_blank" rel="noopener noreferrer" class="linkbox font-semibold py-3 px-4">
                            ...
                            <i class="pi pi-star-fill ms-3 text-yellow-500"></i>
                        </a>
                    </div>
                </div>
                <div class="w-full xl:w-6 pt-7 xl:pt-0 hidden md:block">
                    <div class="flex">
                        <div class="flex flex-column w-6 gap-5 pt-8 pe-3">
                            <div class="box p-4 fadein animation-duration-500 z-1">
                                ...
                                <div class="flex flex-wrap gap-3">
                                    <div class="flex align-items-center">
                                        ...
                                        <label for="category1" class="ms-2 font-medium">Savings</label>
                                    </div>
                                    <div class="flex align-items-center">
                                        <p-radioButton id="category2" [(ngModel)]="radioValue" value="C" name="radiovalue" />
                                        <label for="category2" class="ms-2 font-medium">Checking</label>
                                    </div>
                                </div>
                            ...
                            <div class="box p-4 fadein animation-duration-500">
                                <div class="flex align-items-center">
                                    <p-chip label="Angular" class="me-2 font-medium" />
                                    <p-chip label="Typescript" class="me-2 font-medium" />
                                    <p-inputSwitch [(ngModel)]="switchValue" class="ms-auto"></p-inputSwitch>
                                </div>
                        ...
                        <div class="flex flex-column w-6 gap-5 ps-3">
                            <div class="box p-4 fadein animation-duration-500">
                                ...
                                <div class="flex align-items-center mb-4">
                                    ...
                                    <span class="font-medium text-xl ms-auto">$990</span>
                                </div>
                                ...
                                <ul class="list-none p-0 m-0">
                                    ...
                                    <li class="flex">
                                        <a class="flex align-items-center p-3 border-round w-full hover:surface-hover transition-colors transition-duration-150 cursor-pointer" style="border-radius: '10px'">
                                            <i class="pi pi-home text-xl me-3"></i>
