...
@Component({
    ...
    template: `
        <section class="landing-features py-20">
            ...
            <div class="mt-16 px-20 lg:px-20">
                <div class="features-container">
                    <div class="grid grid-cols-12 gap-4 grid-cols-12 gap-6">
                        <div class="col-span-12 md:col-span-6 xl:col-span-3 flex justify-center">
                            <div class="box p-12 w-full animate-duration-500">
                                ...
                                <div class="font-semibold mb-6 text-lg">80+ UI Components</div>
                        ...
                        <div class="col-span-12 md:col-span-6 xl:col-span-3 flex justify-center">
                            <div class="box p-12 w-full animate-duration-500">
                                ...
                                <div class="font-semibold mb-6 text-lg">Community</div>
                        ...
                        <div class="col-span-12 md:col-span-6 xl:col-span-3 flex justify-center">
                            <div class="box p-12 w-full animate-duration-500">
                                ...
                                <div class="font-semibold mb-6 text-lg">Productivity</div>
                        ...
                        <div class="col-span-12 md:col-span-6 xl:col-span-3 flex justify-center">
                            <div class="box p-12 w-full animate-duration-500">
                                ...
                                <div class="font-semibold mb-6 text-lg">Accessibility</div>
                        ...
                        <div class="col-span-12 md:col-span-6 xl:col-span-3 flex justify-center">
                            <div class="box p-12 w-full animate-duration-500">
                                ...
                                <div class="font-semibold mb-6 text-lg">Enterprise Support</div>
                        ...
                        <div class="col-span-12 md:col-span-6 xl:col-span-3 flex justify-center">
                            <div class="box p-12 w-full animate-duration-500">
                                ...
                                <div class="font-semibold mb-6 text-lg">Mobile</div>
                        ...
                        <div class="col-span-12 md:col-span-6 xl:col-span-3 flex justify-center">
                            <div class="box p-12 w-full animate-duration-500">
                                ...
                                <div class="font-semibold mb-6 text-lg">Themes</div>
                        ...
                        <div class="col-span-12 md:col-span-6 xl:col-span-3 flex justify-center">
                            <div class="box p-12 w-full animate-duration-500">
                                ...
                                <div class="font-semibold mb-6 text-lg">Typescript</div>
