        ...
        <div>
            <div class="flex flex-col xl:flex-row mb-8 gap-8">
                <div class="card xl:w-3/12 m-0 relative overflow-hidden">
                    <i
                        class="pi pi-github absolute text-surface-200 dark:text-surface-600"
                    ...
                    <p class="m-0 leading-normal relative text-lg text-surface-800 dark:text-surface-50">
                        Angular is a fast paced technology with a new major version every 6 months. PrimeNG release cycle is aligned with
                        Angular and every 6 months a new major PrimeNG version is released as open source that is compatible with the latest
                        Angular core. The maintenance releases of the latest PrimeNG version are provided as free and open source for the
                        following 6 months until the new major Angular version is ready.
                    </p>
                </div>
                <div
                    class="card m-0 xl:w-9/12 text-white bg-cover"
                ...
                >
                    ...
                    <p class="m-0 leading-normal text-lg">
                        Majority of the existing applications prefer to remain at a previous version due to stability requirements instead
                        of upgrading to the latest version immediately. PrimeNG LTS is a support service to provide a license for the finest
                        compatible version suited to you. LTS covers the prior two versions from the latest release, this means up to 18
                        months of almost bi-weekly releases to bring the latest defect fixes and security updates to your project. As an
                        example, when PrimeNG moves to Angular 18, v17 and v16 will move to LTS support whereas STS (short term support)
                        versions of PrimeNG 18 will be open source under MIT license for at least 6 months until Angular/PrimeNG 19 is
                        released.
                    </p>
                </div>
            </div>
            <div class="card mb-8">
                ...
                <p class="m-0 leading-normal mb-8 text-secondary text-lg text-surface-800 dark:text-surface-50">
                    <b>STS</b> means open source short term support whereas <b>LTS</b> stands for commercial long term support. Legacy
                    versions are only supported by
                ...
                <div class="flex flex-col md:flex-row gap-8">
                    <div class="flex-1">
                        ...
                        <p class="m-0 leading-normal mb-4 text-secondary text-lg text-surface-800 dark:text-surface-50">
                            PrimeNG comes with a commitment to provide long-term support, including regular security updates to keep your
                    ...
                    <div class="flex-1">
                        ...
                        <p class="m-0 leading-normal mb-4 text-secondary text-lg text-surface-800 dark:text-surface-50">
                            We understand the importance of maintaining a stable and reliable software system. Our team will provide ongoing
                            maintenance to ensure that the software continues to function seamlessly and efficiently.
                        </p>
                    </div>
                    <div class="flex-1">
                        <div class="flex items-center mb-2">
                        ...
                        <p class="m-0 leading-normal mb-4 text-secondary text-lg text-surface-800 dark:text-surface-50">
                            We are dedicated to continuously improving PrimeNG to meet the evolving needs of our users. As part of our
                            long-term support, we will provide regular updates and enhancements to add new features and functionality.
                        </p>
                    </div>
                </div>
            </div>
            <div class="card mb-8">
                ...
                <a href="https://www.primefaces.org/lts/licenses" class="mb-12 text-primary font-medium hover:underline text-center block"
            ...
            <div class="card mb-8">
                ...
                <p class="m-0 leading-normal mb-8 text-secondary text-lg text-surface-800 dark:text-surface-50">
                    LTS versions require a license key and a pass key to be verified at your main app component or main.ts before bootstrap
                    process. The keys would be available at
            ...
            <div class="card m-0">
                ...
                <div class="flex flex-wrap text-lg -ml-8 -mt-8">
                    <div class="w-full lg:w-4/12 p-8">
                        <div class="text-surface-900 dark:text-surface-0 leading-normal mb-2 font-medium">
                            Do I have to purchase a license for PrimeNG?
                        </div>
                        <p class="mt-0 mb-8 p-0 leading-normal text-surface-800 dark:text-surface-50">
                            No, only the versions that have the <b>-lts</b> suffix required a paid license. Any other version is open source
                            under MIT license.
                        </p>
                        ...
                        <p class="mt-0 mb-8 p-0 leading-normal text-surface-800 dark:text-surface-50">
                            No, LTS is totally optional if you cannot update to latest Angular immediately and still would like to receive
                        ...
                        <p class="mt-0 mb-8 p-0 leading-normal text-surface-800 dark:text-surface-50">
                            A message will be displayed at the application screen and license needs to be renewed at PrimeStore. This only
                            applies to Basic License as Extended License has no time limit.
                        </p>
                        ...
                        <p class="mt-0 mb-8 p-0 leading-normal text-surface-800 dark:text-surface-50">
                            Yes, a license key is tied to the major version such as 15 and same license key cannot be used on another major
                            version like 14.
                        </p>
                    ...
                    <div class="w-full lg:w-4/12 p-8">
                        ...
                        <p class="mt-0 mb-8 p-0 leading-normal text-surface-800 dark:text-surface-50">
                            LTS releases have <span class="font-bold">-lts</span> suffix such as <span class="font-bold">14.2.4-lts</span>.
                        </p>
                    ...
                    <div class="w-full lg:w-4/12 p-8">
                        ...
                        <p class="mt-0 p-0 leading-normal text-surface-800 dark:text-surface-50">
                            PrimeNG PRO is a premium support service delivered via an exclusive JIRA instance where support engineers of
                            PrimeTek provide assistance within 1 business day to the raised tickets. LTS on the other hand provides a
