        ...
        <div>
            <div style="border-radius: 50px; max-height: 500px" class="overflow-hidden mb-8 flex items-center">
                <img
                    ...
                    src="https://primefaces.org/cdn/primeng/images/uikit/primeone-cover-{{ isDarkMode ? 'dark' : 'light' }}.jpeg"
                    class="w-full"
                />
            </div>
            ...
            <div class="card mb-8" style="border-radius: 50px">
                ...
                <div class="flex flex-col md:flex-row items-center gap-6 md:gap-20 mb-20">
                    <div class="w-full md:w-6/12">
                        ...
                        <p class="mb-4 text-lg">
                            Save countless hours on every project with a carefully designed system that uses Prime UI Suite components.
                            Start producing design results in no time.
                        </p>
                ...
                <div class="flex flex-col md:flex-row items-center gap-6 md:gap-20">
                    <div class="w-full md:w-6/12">
                        ...
                        <p class="mb-4 text-lg">
                            Empower yourself with unprecedented control over your designs. Tokens Studio integration unlocks a whole new
                            level of flexibility, allowing you to create and manage design tokens seamlessly.
                        </p>
            ...
            <div class="card mb-8" style="border-radius: 50px">
                ...
                <div class="mb-2 text-center leading-normal text-lg">
                    Choose the right plan for your business. Whether you are an individual or a member of a team, UI Kit is available for
                    affordable prices.
                </div>
                <a href="https://www.primefaces.org/uikit/licenses" class="mb-12 text-primary font-medium hover:underline text-center block"
                    ...
                    <div class="col-span-12 lg:col-span-4">
                        <div class="p-4 h-full">
                            <div class="shadow p-8 h-full flex flex-col bg-surface-0 dark:bg-surface-900" style="border-radius: 6px">
                                ...
                                <a
                                    href="https://www.primefaces.org/store/uikit.xhtml"
                                    pRipple
                                    class="bg-blue-500 text-white hover:bg-blue-400 p-4 w-full rounded-border text-center transition-colors duration-300 font-bold"
                                    >Buy Now</a
                                >
                            </div>
                        </div>
                        ...
                        <div class="p-4 h-full">
                            <div class="shadow p-8 h-full flex flex-col bg-surface-0 dark:bg-surface-900" style="border-radius: 6px">
                                ...
                                <a
                                    href="https://www.primefaces.org/store/uikit.xhtml"
                                    pRipple
                                    class="bg-purple-500 text-white hover:bg-purple-400 p-4 w-full rounded-border text-center transition-colors duration-300 font-bold"
                                    >Buy Now</a
                                >
                            </div>
                        </div>
                        ...
                        <div class="p-4 h-full">
                            <div class="shadow p-8 flex flex-col bg-surface-0 dark:bg-surface-900" style="border-radius: 6px">
                                ...
                                <a
                                    ...
                                    pRipple
                                    class="bg-slate-500 text-white hover:bg-slate-400 p-4 w-full rounded-border text-center transition-colors duration-300 font-bold"
                                    >Contact Us</a
                                >
                            </div>
                        </div>
            ...
            <div class="card" style="border-radius: 50px">
                <span class="block font-bold text-5xl mb-8 text-center text-surface-900 dark:text-surface-0"
                ...
                <div class="grid grid-cols-12 gap-4">
                    ...
                    <div class="col-span-12 lg:col-span-4 px-2 lg:px-8">
                        <div class="text-xl text-surface-900 dark:text-surface-0 leading-normal mb-2 text-surface-900 dark:text-surface-0">
                            We're a reseller, are we able to purchase a license on behalf of our client?
                        </div>
                        <p class="mt-0 mb-12 p-0 leading-normal text-lg text-surface-800 dark:text-surface-50">
                            Yes, after the purchase, please
                            <a href="mailto:contact@primetek.com.tr" class="text-primary font-medium hover:underline">contact us</a> so we
                            can transfer the license to your client.
                        </p>
                    ...
                    <div class="col-span-12 lg:col-span-4 px-2 lg:px-8">
                        ...
                        <p class="mt-0 mb-12 p-0 leading-normal text-lg text-surface-800 dark:text-surface-50">
                            ...
                            <a
                                href="https://github.com/orgs/primefaces/discussions/categories/figma-ui-kit"
                                class="text-primary font-medium hover:underline"
                                >a dedicated forum channel monitored</a
                            >
                        ...
                        <p class="mt-0 mb-12 p-0 leading-normal text-lg text-surface-800 dark:text-surface-50">
                            Due to the license, it is not possible to use the UI Kit in an open source project where the design files are
                            publicly available.
                        </p>
                    </div>
                </div>
