...
@Component({
    ...
    template: ` <div>
        <div class="doc-intro">
            <h1>Partners</h1>
            <p>
                PrimeTek proudly collaborates with a diverse range of partners, each bringing their unique expertise and contributions to
                the table. These partnerships play a pivotal role in our pursuit of delivering exceptional software solutions and driving
            ...
            <ul class="list-none p-0 m-0">
                <li class="flex flex-col md:flex-row items-center gap-8 border-b border-surface pb-8">
                    ...
                    <div class="flex flex-col flex-1 gap-2">
                        ...
                        <span class="text-lg leading-normal"
                            >Full code RAD platform with predefined modules and all around infrastructure to launch your high quality
                            products to market in no time.</span
                        >
                    </div>
                </li>
                <li class="flex flex-col md:flex-row items-center gap-8 mb-8 border-b border-surface py-8">
                    ...
                    <div class="flex flex-col flex-1 gap-2">
                        ...
                        <span class="text-lg leading-normal"
                            >PrimeTek is now partnering with T2 Software to connect you with experienced development teams that can build
                            feature-rich, end-to-end custom applications.</span
                        >
                    </div>
                </li>
                <li class="flex flex-col md:flex-row items-center gap-8 mb-8 pt-8">
                    ...
                    <div class="flex flex-col flex-1 gap-2">
                        ...
                        <span class="text-lg leading-normal"
                            >Virtua.tech is a PrimeTek reseller and also provides expert assistance with architecture, development,
                            mentoring, and training for PrimeTek products as well as Capacitor, Jakarta EE, MicroProfile, and other
                            technologies.</span
                        >
                    </div>
                </li>
