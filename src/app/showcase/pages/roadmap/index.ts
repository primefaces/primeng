    ...
    template: `
        <div>
            <div class="doc-intro">
                <h1>Roadmap</h1>
                <p>
                    At <a href="https://www.primetek.com.tr/" class="text-primary font-medium hover:underline">PrimeTek</a>, we are
                    passionate about improving PrimeNG and would like to share our ideas for 2024 with the community. These are planned to
                    be implemented in parallel to the regular maintenance work of the library involving review of issue tickets, PRs and
                    PrimeNG PRO support.
                </p>
            </div>
                ...
                <div style="min-width: 1200px">
                    ...
                    <div class="flex flex-col gap-4">
                        <div class="flex gap-4 border-b border-surface pb-4">
                            <div
                                class="shrink-0 p-4 bg-blue-500 text-white rounded-border font-bold text-lg flex items-center justify-center w-56"
                            >
                                COMPONENTS
                            </div>
                            <div class="flex-1 flex gap-4 flex-col">
                                <div
                                    class="p-4 bg-surface-0 dark:bg-surface-900 rounded-border border-blue-500"
                        ...
                        <div class="flex gap-4 border-b border-surface pb-4">
                            <div
                                class="shrink-0 p-4 bg-indigo-500 text-white rounded-border font-bold text-lg flex items-center justify-center w-56"
                            >
                                FIGMA UI Kit
                            </div>
                            <div class="flex-1 flex gap-4 flex-col">
                                <div
                                    class="p-4 bg-surface-0 dark:bg-surface-900 rounded-border border-indigo-500"
                                    style="border-left: 6px solid"
                                >
                        ...
                        <div class="flex gap-4 border-b border-surface pb-4">
                            <div
                                class="shrink-0 p-4 bg-teal-500 text-white rounded-border font-bold text-lg flex items-center justify-center w-56"
                            >
                                SHOWCASE
                            </div>
                            <div class="flex-1 flex gap-4 flex-col">
                                <div
                                    class="p-4 bg-surface-0 dark:bg-surface-900 rounded-border border-teal-500"
                                    style="border-left: 6px solid"
                                >
                        ...
                        <div class="flex gap-4 border-b border-surface pb-4">
                            <div
                                class="shrink-0 p-4 bg-orange-500 text-white rounded-border font-bold text-lg flex items-center justify-center w-56"
                            >
                                PRIMEBLOCKS
                            </div>
                            <div class="flex-1 flex gap-4 flex-col">
                                <div
                                    class="p-4 bg-surface-0 dark:bg-surface-900 rounded-border border-orange-500"
                                    style="border-left: 6px solid"
                                >
                        ...
                        <div class="flex gap-4 border-b border-surface pb-4">
                            <div
                                class="shrink-0 p-4 bg-pink-500 text-white rounded-border font-bold text-lg flex items-center justify-center w-56"
                            >
                                DESIGN
                            </div>
                            <div class="flex-1 flex gap-4 flex-col">
                                <div
                                    class="p-4 bg-surface-0 dark:bg-surface-900 rounded-border border-pink-500"
                                    style="border-left: 6px solid"
                                >
