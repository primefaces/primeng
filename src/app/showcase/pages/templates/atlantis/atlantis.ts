...
@Component({
    ...
    template: `<div class="atlantis template">
        ...
        <div [style.display]="'none'">
            <atlantis-separator></atlantis-separator>
            <template-youtube
                imgSrc="https://primefaces.org/cdn/primeng/images/templates/atlantis/atlantis-youtube-screen.png"
            ></template-youtube>
        </div>
...
export class AtlantisPage {
    ...
    templateHeroData = {
        ...
        description:
            'Prepare to be amazed by the remastered Atlantis for PrimeNG featuring a new gorgeous dark mode for the entire layout, 5 menu modes, reusable css widgets, utilities, modern icons and many more.',
