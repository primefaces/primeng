            ...
            <span class="template-separator-icon">
                <svg xmlns="http://www.w3.org/2000/svg" width="48" height="49" viewBox="0 0 48 49" fill="none">
                    <g clipPath="url(#clip0_987_15401)">
                        ...
                        <path
                            d="M22.9547 12.4471L22.834 12.375L14.0757 28.5054L14.1964 28.5775L22.9547 12.4471Z"
                            [attr.fill]="fillColor"
                            fillOpacity="0.5"
                        />
                        <path
                            d="M26.8757 12.8025L26.7551 12.7302L16.4265 31.7024L16.5214 31.7932L26.8757 12.8025Z"
                            [attr.fill]="fillColor"
                        />
                        <path
                            d="M30.1539 14.3382L30.0337 14.2654L19.3041 33.7536L19.4244 33.8264L30.1539 14.3382Z"
                            [attr.fill]="fillColor"
                        />
                        <path
                            d="M32.6656 17.4603L32.5459 17.3865L22.8027 34.7793L22.9225 34.8531L32.6656 17.4603Z"
                            [attr.fill]="fillColor"
                        />
                        <path d="M34.541 21.3825L34.4209 21.3094L27.2179 34.3463L27.338 34.4193L34.541 21.3825Z" [attr.fill]="fillColor" />
                        <path
                            d="M28.4863 25.8294L32.9655 17.778L34.3133 20.6083L28.0059 32.0445L18.5141 14.5333L20.9781 13.2376L27.6071 25.8194L28.0375 26.6363L28.4863 25.8294Z"
                            [attr.fill]="fillColor"
