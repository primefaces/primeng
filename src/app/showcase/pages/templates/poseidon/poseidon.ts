...
export class PoseidonPage {
    ...
    templateHeroData = {
        ...
        description:
            'A modern and easy to use premium application template with various color schemes.Based on flat design language, it is fully responsive, touch optimized, built with SASS, CSS3 and HTML5.',
    ...
    animationFeaturesData1 = [
        ...
        },
        {
            ...
            title: 'PrimeIcons',
            description:
                'Poseidon ships with PrimeIcons, PrimeTek’s modern icon library including a wide range of icons for your applications.',
    ...
    animationFeaturesData2 = [
        ...
        },
        {
            ...
            description:
                'Poseidon offers 12 built-in component themes with dark, light and dim options. Also if you wanna create your own theme you can do it by just defining couple SASS variables.',
