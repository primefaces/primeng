...
@Component({
    ...
    template: `<div class="diamond template">
        ...
        <div [style.display]="'none'">
            <diamond-separator></diamond-separator>
            <template-youtube
                imgSrc="https://primefaces.org/cdn/primeng/images/templates/diamond/diamond-youtube-screen.png"
            ></template-youtube>
        </div>
...
export class DiamondPage {
    ...
    templateHeroData = {
        ...
        description:
            'A spectacular application template with light&dark modes, beautiful main menu with themes and layouts, premium PrimeNG component themes, reusable css widgets, utilities, modern icons and professional template pages.',
    ...
    animationFeaturesData1 = [
        ...
        },
        {
            ...
            title: 'PrimeIcons',
            description:
                'Diamond ships with PrimeIcons, PrimeTek’s modern icon library including a wide range of icons for your applications.',
    ...
    animationFeaturesData2 = [
        ...
        },
        {
            ...
            description:
                'Diamond offers 30 built-in component themes and creating your own theme is a matter of defining couple of sass variables.',
