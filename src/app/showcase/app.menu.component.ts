        ...
        <div class="layout-sidebar" [ngClass]="{ active: active }">
            <a [routerLink]="['/']" class="logo">
                <img
                    ...
                    [src]="
                        ...
                        (config.dark
                            ? 'primeng-logo-light.svg'
                            : 'primeng-logo-dark.svg')
                    "
                    height="41"
                />
            </a>
            ...
            <div class="layout-menu">
                ...
                <div class="menu-items">
                    ...
                    >
                    <a
                        href="https://github.com/primefaces/primeng/wiki/Migration-Guide"
                        target="_blank"
                        >Migration Guide</a
                    >
                </div>
                ...
                <div class="menu-items">
                    ...
                    >
                    <a
                        href="https://www.primefaces.org/designer/api/primeng/13.0.0"
                        >SASS API</a
                    >
                </div>
                ...
                <div class="menu-items">
                    <a
                        href="https://www.primefaces.org/primeblocks-ng/#/free"
                        target="_blank"
                        >Free Blocks</a
                    >
                    <a
                ...
                <div class="menu-items">
                    ...
                    <a
                        ...
                        routerLinkActive="router-link-exact-active"
                        >TreeSelect <span class="p-tag">New</span></a
                    >
                    <a
                ...
                <div class="menu-items">
                    ...
                    <a
                        ...
                        routerLinkActive="router-link-exact-active"
                        >SpeedDial <span class="p-tag">New</span></a
                    >
                </div>
                ...
                <div class="menu-items">
                    ...
                    >
                    <div>
                        <a tabindex="0" (click)="toggleSubmenu($event, 'table')"
                            >Table <span class="p-tag">New</span></a
                        >
                        <div
                            [@submenu]="
                                isSubmenuActive('table') ? 'visible' : 'hidden'
                            "
                            (@submenu.done)="onAnimationDone()"
                        >
                            <ul>
                                <li>
                                    <a
                                ...
                                <li>
                                    <a
                                        [routerLink]="['table/scroll']"
                                        routerLinkActive="router-link-exact-active"
                                        [routerLinkActiveOptions]="{
                                            exact: true
                                        }"
                                        >Scroll
                                        <span class="p-tag">New</span></a
                                    >
                                </li>
                                <li>
                                    <a
                                        [routerLink]="['table/virtualscroll']"
                                        routerLinkActive="router-link-exact-active"
                                        [routerLinkActiveOptions]="{
                                            exact: true
                                        }"
                    ...
                    <div>
                        <a tabindex="0" (click)="toggleSubmenu($event, 'tree')"
                            >Tree</a
                        >
                        <div
                            [@submenu]="
                                isSubmenuActive('tree') ? 'visible' : 'hidden'
                            "
                            (@submenu.done)="onAnimationDone()"
                        >
                            <ul>
                    ...
                    <div>
                        <a
                            tabindex="0"
                            (click)="toggleSubmenu($event, 'treetable')"
                            >TreeTable</a
                        >
                        <div
                            [@submenu]="
                                isSubmenuActive('treetable')
                                    ? 'visible'
                                    : 'hidden'
                            "
                            (@submenu.done)="onAnimationDone()"
                        >
                            <ul>
                                ...
                                <li>
                                    <a
                                        [routerLink]="['treetable/templating']"
                                        routerLinkActive="router-link-exact-active"
                                        [routerLinkActiveOptions]="{
                                            exact: true
                                        }"
                                ...
                                <li>
                                    <a
                                        [routerLink]="['treetable/selection']"
                                        routerLinkActive="router-link-exact-active"
                                        [routerLinkActiveOptions]="{
                                            exact: true
                                        }"
                                ...
                                <li>
                                    <a
                                        [routerLink]="['treetable/colresize']"
                                        routerLinkActive="router-link-exact-active"
                                        [routerLinkActiveOptions]="{
                                            exact: true
                                        }"
                                ...
                                <li>
                                    <a
                                        [routerLink]="['treetable/coltoggle']"
                                        routerLinkActive="router-link-exact-active"
                                        [routerLinkActiveOptions]="{
                                            exact: true
                                        }"
                                ...
                                <li>
                                    <a
                                        [routerLink]="['treetable/contextmenu']"
                                        routerLinkActive="router-link-exact-active"
                                        [routerLinkActiveOptions]="{
                                            exact: true
                                        }"
                                ...
                                <li>
                                    <a
                                        [routerLink]="['treetable/responsive']"
                                        routerLinkActive="router-link-exact-active"
                                        [routerLinkActiveOptions]="{
                                            exact: true
                                        }"
                ...
                <div class="menu-items">
                    ...
                    <a
                        [routerLink]="['dock']"
                        routerLinkActive="router-link-exact-active"
                        >Dock <span class="p-tag">New</span></a
                    >
                    <a
                        [routerLink]="['megamenu']"
                        routerLinkActive="router-link-exact-active"
                ...
                <div class="menu-items">
                    ...
                    <div>
                        <a
                            tabindex="0"
                            (click)="toggleSubmenu($event, 'galleria')"
                            >Galleria</a
                        >
                        <div
                            [@submenu]="
                                isSubmenuActive('galleria')
                                    ? 'visible'
                                    : 'hidden'
                            "
                            (@submenu.done)="onAnimationDone()"
                        >
                            <ul>
                                ...
                                <li>
                                    <a
                                        [routerLink]="['galleria/programmatic']"
                                        routerLinkActive="router-link-exact-active"
                                        [routerLinkActiveOptions]="{
                                            exact: true
                                        }"
                                ...
                                <li>
                                    <a
                                        [routerLink]="['galleria/responsive']"
                                        routerLinkActive="router-link-exact-active"
                                        [routerLinkActiveOptions]="{
                                            exact: true
                                        }"
                                ...
                                <li>
                                    <a
                                        [routerLink]="['galleria/fullscreen']"
                                        routerLinkActive="router-link-exact-active"
                                        [routerLinkActiveOptions]="{
                                            exact: true
                                        }"
                    ...
                    <a
                        [routerLink]="['image']"
                        routerLinkActive="router-link-exact-active"
                        >Image <span class="p-tag">New</span></a
                    >
                </div>
                ...
                <div class="menu-items">
                    ...
                    <a
                        [routerLink]="['tag']"
                        routerLinkActive="router-link-exact-active"
                        >Tag <span class="p-tag">Tag</span></a
                    >
                    <a
                        [routerLink]="['terminal']"
                        routerLinkActive="router-link-exact-active"
                ...
                <div class="menu-items">
                    ...
                    <a
                        ...
                        routerLinkActive="router-link-exact-active"
                        >StyleClass <span class="p-tag">New</span></a
                    >
                    <a
                        [routerLink]="['ripple']"
                        routerLinkActive="router-link-exact-active"
...
export class AppMenuComponent {
    ...
    routes = [
        ...
        },
        {
            label: "PrimeIcons",
            value: "primeicons",
            items: [{ label: "Icons v5", value: "/icons" }],
        },
        {
            label: "Form",
            value: "form",
    ...
    constructor(
        ...
        router.events.subscribe((routerEvent) => {
            if (
                ...
                (routerEvent.navigationTrigger === "popstate" ||
                    this.scrollable)
            ) {
                let routeUrl = routerEvent.url;

                if (
                    this.isSubmenu(routeUrl) &&
                    !this.isSubmenuActive("/" + routeUrl.split("/")[1])
                ) {
    ...
    scrollToSelectedRoute() {
        let routeEl = DomHandler.findSingle(
    ...
    isSubmenu(route) {
        return (
            ...
            route.includes("treetable") ||
            route.includes("tree") ||
            route.includes("galleria")
        );
    }
