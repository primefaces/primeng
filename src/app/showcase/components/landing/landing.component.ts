...
export class LandingComponent implements OnInit, OnDestroy {
  ...
  constructor(private nodeService: NodeService, private customerService: CustomerService, private configService: AppConfigService, public appMain: AppMainComponent) { }
