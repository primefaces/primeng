...
@Component({
    selector: 'menu-accessibility-doc',
    template: ` <div>
        <app-docsectiontext>
            <h3>Screen Reader</h3>
            <p>
                Menu component uses the <i>menu</i> role and the value to describe the menu can either be provided with
                ...
                the item is disabled. A submenu within a Menu uses the <i>group</i> role with an <i>aria-labelledby</i> defined as the id of
                the submenu root menuitem label.
            </p>
            <p>
