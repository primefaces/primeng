...
@Component({
    ...
    template: `
        <app-docsectiontext>
            <p>Sidebar location is configured with the <i>position</i> property that can take <i>start</i>, <i>end</i>, <i>top</i> and <i>bottom</i> as a value.</p>
        </app-docsectiontext>
        <div class="card flex flex-wrap justify-content-center gap-2">
            <p-sidebar [(visible)]="sidebarVisible1" position="start">
                <h3>Start Sidebar</h3>
            </p-sidebar>

            <p-sidebar [(visible)]="sidebarVisible2" position="end">
                <h3>End Sidebar</h3>
            </p-sidebar>
...
export class PositionDoc {
    ...
    code: Code = {
        basic: `<p-sidebar [(visible)]="sidebarVisible1" position="start">
    <h3>Start Sidebar</h3>
</p-sidebar>
