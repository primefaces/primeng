        ...
        <div>
            <app-docsectiontext [title]="title" [id]="id">
                ...
                <p>
                    ...
                    the <a routerLink="/locale">locale</a> API respectively.
                </p>
                <p>
                    Page links are also button elements with an <i>aria-label</i> attribute derived from the <i>aria.pageLabel</i> of the <a routerLink="/locale">locale</a> API. Current page is marked with <i>aria-current</i> set to "page" as well.
                </p>
                ...
                <p>
                    ...
                    <i>aria.rowsPerPage</i> property of the <a routerLink="/locale">locale</a> API.
                </p>
                <p>Jump to page input is an <i>input</i> element with an <i>aria-label</i> that refers to the <i>aria.jumpToPage</i> property of the <a routerLink="/locale">locale</a> API.</p>
