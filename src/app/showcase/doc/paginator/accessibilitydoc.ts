    ...
    template: `
        <div>
            <app-docsectiontext [title]="title" [id]="id">
                ...
                <p>
                    Page links are also button elements with an <i>aria-label</i> attribute derived from the <i>aria.pageLabel</i> of the <a href="/configuration/#locale">locale</a> API. Current page is marked with <i>aria-current</i> set to "page"
                    as well.
                </p>
