...
@Component({
    ...
    template: `
        <app-docsectiontext>
            <p>
                Only one tab at a time can be active by default, enabling <i>multiple</i> property changes this behavior to allow multiple
                tabs. In this case <i>activeIndex</i> needs to be an array.
            </p>
        </app-docsectiontext>
        <div class="card flex justify-content-center">
            <p-accordion [multiple]="true" [activeIndex]="[0]">
                <p-accordion-tab header="Header I">
                    <p>
                ...
                <p-accordion-tab header="Header II">
                    <p>
                ...
                <p-accordion-tab header="Header III">
                    <p>
...
export class MultipleDoc {
    code: Code = {
        basic: `<p-accordion [multiple]="true" [activeIndex]="[0]">
    <p-accordion-tab header="Header I">
        <p>
