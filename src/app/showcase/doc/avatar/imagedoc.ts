    ...
    template: `
        ...
        <div class="card">
            <div class="flex flex-wrap gap-5">
                <div class="flex-auto">
                    <p-avatar image="https://primefaces.org/cdn/primeng/images/demo/avatar/amyelsner.png" styleClass="me-2" size="xlarge" shape="circle" />
                    <p-avatar image="https://primefaces.org/cdn/primeng/images/demo/avatar/asiyajavayant.png" styleClass="me-2" size="large" shape="circle" />
                    <p-avatar image="https://primefaces.org/cdn/primeng/images/demo/avatar/onyamalimba.png" styleClass="me-2" shape="circle" />
                </div>
                <div class="flex-auto">
                    <h5>Badge</h5>
                ...
                <div class="flex-auto">
                    <h5>Gravatar</h5>
                    <p-avatar image="https://www.gravatar.com/avatar/05dfd4b41340d09cae045235eb0893c3?d=mp" styleClass="flex align-items-center justify-content-center me-2" size="xlarge" />
                </div>
            </div>
        </div>
...
<p-avatar
    ...
    styleClass="flex align-items-center justify-content-center me-2"
    size="xlarge" />`,
        html: `<div class="card">
    <div class="flex flex-wrap gap-5">
        <div class="flex-auto">
