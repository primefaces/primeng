...
@Component({
    ...
    template: `
        ...
        <div class="card flex justify-content-center">
            <i class="pi pi-bell me-4 p-text-secondary" pBadge style="font-size: 2rem" value="2"></i>
            <i class="pi pi-calendar me-4 p-text-secondary" pBadge style="font-size: 2rem" [value]="'10+'" severity="danger"></i>
...
export class PositionDoc {
    code: Code = {
        basic: `<i class="pi pi-bell me-4 p-text-secondary" pBadge style="font-size: 2rem" value="2"></i>`,
