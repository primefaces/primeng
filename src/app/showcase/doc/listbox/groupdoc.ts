...
@Component({
    ...
    template: ` <section class="py-4">
        ...
        <div class="card flex justify-content-center">
            <p-listbox [options]="groupedCities" [group]="true" [(ngModel)]="selectedCountry" [listStyle]="{ 'max-height': '250px' }" [style]="{ width: '15rem' }" optionGroupLabel="label" optionGroupChildren="items" optionLabel="label">
