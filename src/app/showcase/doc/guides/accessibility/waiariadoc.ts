...
@Component({
    ...
    template: `
        <app-docsectiontext>
            ...
            <p class="doc-section-description mt-4">One alternative is using ARIA roles for readers and use javascript for keyboard support. Notice the usage of <i>aria-labelledby</i> as a replacement of the <i>label</i> tag with for.</p>
