...
@Component({
    ...
    template: ` <app-developmentsection>
        <app-docsectiontext [title]="title" [id]="id">
            ...
            <p>
                Next and Previous navigators are button elements with <i>aria-label</i> attributes referring to the <i>aria.nextPageLabel</i> and <i>aria.firstPageLabel</i> properties of the <a routerLink="/locale">locale</a> API by default respectively,
                you may still use your own aria roles and attributes as any valid attribute is passed to the button elements implicitly by using <i>nextButtonProps</i> and <i>prevButtonProps</i>.
            </p>
            <p>Quick navigation elements are button elements with an <i>aria-label</i> attribute referring to the <i>aria.pageLabel</i> of the <a routerLink="/locale">locale</a> API. Current page is marked with <i>aria-current</i>.</p>
