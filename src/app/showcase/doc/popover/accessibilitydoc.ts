...
@Component({
    selector: 'popover-accessibility-doc',
    template: ` <div>
        <app-docsectiontext>
            <h3>Screen Reader</h3>
            <p>
                Popover component uses <i>dialog</i> role and since any attribute is passed to the root element you may define attributes
                like <i>aria-label</i> or <i>aria-labelledby</i> to describe the popup contents. In addition <i>aria-modal</i> is added
                since focus is kept within the popup.
            </p>
            <p>
                It is recommended to use a trigger component that can be accessed with keyboard such as a button, if not adding
                <i>tabIndex</i> would be necessary. Popover adds <i>aria-expanded</i> state attribute and <i>aria-controls</i> to the
            ...
            <p>
                ...
                <i>autofocus</i> to an element within the popup.
            </p>
