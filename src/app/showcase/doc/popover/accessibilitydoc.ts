...
@Component({
    ...
    template: ` <div>
        <app-docsectiontext>
            ...
            <p>
                It is recommended to use a trigger component that can be accessed with keyboard such as a button, if not adding <i>tabIndex</i> would be necessary. Popover adds <i>aria-expanded</i> state attribute and <i>aria-controls</i> to the
