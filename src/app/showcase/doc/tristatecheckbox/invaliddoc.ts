...
@Component({
    ...
    template: `
        ...
        <div class="card flex flex-column gap-3 align-items-center">
            <p-triStateCheckbox [(ngModel)]="value" inputId="tricheckbox" styleClass="ng-invalid ng-dirty"></p-triStateCheckbox>
...
export class InvalidDoc {
    ...
    code: Code = {
        basic: `<p-triStateCheckbox [(ngModel)]="value" inputId="tricheckbox" styleClass="ng-invalid ng-dirty"></p-triStateCheckbox>
<label class="p-tristatecheckbox-label" for="tricheckbox">{{ value === null ? 'null' : value }}</label>`,
