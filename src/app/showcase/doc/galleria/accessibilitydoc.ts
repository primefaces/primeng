    ...
    template: ` <app-developmentsection>
        <app-docsectiontext [title]="title" [id]="id">
            ...
            <p>
                ...
                <i>aria-label</i> attribute of a quick navigation item refers to the <i>aria.pageLabel</i> of the <a routerLink="/locale">locale</a> API. Current page is marked with <i>aria-current</i>.
            </p>
