    ...
    template: ` <app-developmentsection>
        <div>
            <app-docsectiontext [title]="title" [id]="id">
                ...
                <p>
                    Closable inplace components displays a button with an <i>aria-label</i> that refers to the <i>aria.close</i> property of the <a routerLink="/locale">locale</a> API by default, you may use<i>closeButtonProps</i> to customize the element
