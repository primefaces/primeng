...
@Component({
    ...
    template: `
        <app-docsectiontext>
            <p>Available options and the selected options support templating with <i>pTemplate</i> properties respectively. In addition, dropdown, header, footer and filter sections can be templated as well.</p>
        </app-docsectiontext>
