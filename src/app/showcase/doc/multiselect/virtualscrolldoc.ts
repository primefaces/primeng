...
@Component({
    ...
    template: ` <section>
        ...
        <app-code [code]="code" selector="multiselect-virtual-scroll-demo"></app-code>
    </section>`
})
...
@Component({
    selector: 'multiselect-virtual-scroll-demo',
    templateUrl: './multiselect-virtual-scroll-demo.html'
})
