    ...
    template: `
        <div class="w-full h-[56rem] md:h-[32rem] xl:h-[36.25rem] bg-primary rounded-3xl overflow-hidden relative">
            <ng-container *ngIf="!!templateHeroData?.pattern">
                <img
                    class="select-none absolute md:bottom-0 bottom-80 left-0 z-[6] md:w-[95rem] h-auto w-[90rem] opacity-60"
                    width="1344"
                    [src]="templateHeroData.pattern"
            ...
            <div
                class="absolute left-1/2 top-20 -translate-x-1/2 md:translate-x-0 md:top-1/2 md:-translate-y-1/2 md:left-10 lg:left-20 xl:left-36 z-20 w-[92%] max-w-lg md:w-[26rem] lg:w-[28rem] xl:w-[29rem] rounded-3xl p-7 lg:px-9 lg:py-7"
            >
                <div
                ...
                <div class="z-10 relative">
                    ...
                    <div class="flex items-center gap-4 mt-8">
                        <a
                            ...
                            target="_blank"
                            class="flex-1 py-3.5 border border-primary-contrast hover:bg-primary-contrast/10 text-primary-contrast rounded-full text-center font-semibold transition-all leading-none"
                        >
                            Live Demo
                        </a>
                        <a
                    ...
                    <div class="flex items-center gap-4 mt-6">
                        <a
                            [href]="
                                templateHeroData?.supportHref ??
                                'https://github.com/orgs/primefaces/discussions/categories/primeng-templates'
                            "
                            target="_blank"
                            class="flex items-center gap-2 text-primary-contrast lg:text-base text-sm"
                        >
