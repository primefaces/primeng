...
export const routes: Routes = [
    { path: '', component: LandingComponent, pathMatch: 'full' },
    {
        ...
        children: [
            ...
            {
                path: 'customicons',
                loadChildren: () => import('@pages/customicons/customiconsdemo.module').then((m) => m.CustomIconsDemoModule),
            },
            ...
            {
                path: 'breadcrumb',
                loadChildren: () => import('@pages/breadcrumb/breadcrumbdemo.module').then((m) => m.BreadcrumbDemoModule),
            },
            { path: 'button', loadChildren: () => import('@pages/button/buttondemo.module').then((m) => m.ButtonDemoModule) },
            {
                path: 'datepicker',
                loadChildren: () => import('@pages/datepicker/datepickerdemo.module').then((m) => m.DatePickerDemoModule),
            },
            { path: 'card', loadChildren: () => import('@pages/card/carddemo.module').then((m) => m.CardDemoModule) },
            {
                path: 'cascadeselect',
                loadChildren: () => import('@pages/cascadeselect/cascadeselectdemo.module').then((m) => m.CascadeSelectDemoModule),
            },
            ...
            {
                path: 'confirmdialog',
                loadChildren: () => import('@pages/confirmdialog/confirmdialogdemo.module').then((m) => m.ConfirmDialogDemoModule),
            },
            {
                path: 'confirmpopup',
                loadChildren: () => import('@pages/confirmpopup/confirmpopupdemo.module').then((m) => m.ConfirmPopupDemoModule),
            },
            {
                path: 'contextmenu',
                loadChildren: () => import('@pages/contextmenu/contextmenudemo.module').then((m) => m.ContextMenuDemoModule),
            },
            ...
            {
                path: 'dynamicdialog',
                loadChildren: () => import('@pages/dynamicdialog/dynamicdialogdemo.module').then((m) => m.DynamicDialogDemoModule),
            },
            ...
            {
                path: 'floatlabel',
                loadChildren: () => import('@pages/floatlabel/floatlabeldemo.module').then((m) => m.FloatLabelDemoModule),
            },
            { path: 'fieldset', loadChildren: () => import('@pages/fieldset/fieldsetdemo.module').then((m) => m.FieldsetDemoModule) },
            {
                path: 'fileupload',
                loadChildren: () => import('@pages/fileupload/fileuploaddemo.module').then((m) => m.FileUploadDemoModule),
            },
            {
                path: 'filterservice',
                loadChildren: () => import('@pages/filterservice/filterservicedemo.module').then((m) => m.FilterServiceDemoModule),
            },
            ...
            {
                path: 'metergroup',
                loadChildren: () => import('@pages/metergroup/metergroupdemo.module').then((m) => m.MeterGroupDemoModule),
            },
            { path: 'inputmask', loadChildren: () => import('@pages/inputmask/inputmaskdemo.module').then((m) => m.InputMaskDemoModule) },
            {
                path: 'inputnumber',
                loadChildren: () => import('@pages/inputnumber/inputnumberdemo.module').then((m) => m.InputNumberDemoModule),
            },
            { path: 'inputotp', loadChildren: () => import('@pages/inputotp/inputotpdemo.module').then((m) => m.InputOtpDemoModule) },
            {
                path: 'toggleswitch',
                loadChildren: () => import('@pages/toggleswitch/toggleswitchdemo.module').then((m) => m.ToggleSwitchDemoModule),
            },
            ...
            {
                path: 'progressbar',
                loadChildren: () => import('@pages/progressbar/progressbardemo.module').then((m) => m.ProgressBarDemoModule),
            },
            {
                path: 'progressspinner',
                loadChildren: () => import('@pages/progressspinner/progressspinnerdemo.module').then((m) => m.ProgressSpinnerDemoModule),
            },
            {
                path: 'radiobutton',
                loadChildren: () => import('@pages/radiobutton/radiobuttondemo.module').then((m) => m.RadioButtonDemoModule),
            },
            ...
            {
                path: 'scrollpanel',
                loadChildren: () => import('@pages/scrollpanel/scrollpaneldemo.module').then((m) => m.ScrollPanelDemoModule),
            },
            { path: 'scrolltop', loadChildren: () => import('@pages/scrolltop/scrolltopdemo.module').then((m) => m.ScrollTopDemoModule) },
            {
                path: 'selectbutton',
                loadChildren: () => import('@pages/selectbutton/selectbuttondemo.module').then((m) => m.SelectButtonDemoModule),
            },
            ...
            {
                path: 'splitbutton',
                loadChildren: () => import('@pages/splitbutton/splitbuttondemo.module').then((m) => m.SplitButtonDemoModule),
            },
            ...
            {
                path: 'styleclass',
                loadChildren: () => import('@pages/styleclass/styleclassdemo.module').then((m) => m.StyleClassDemoModule),
            },
            ...
            {
                path: 'tieredmenu',
                loadChildren: () => import('@pages/tieredmenu/tieredmenudemo.module').then((m) => m.TieredMenuDemoModule),
            },
            ...
            {
                path: 'togglebutton',
                loadChildren: () => import('@pages/togglebutton/togglebuttondemo.module').then((m) => m.ToggleButtonDemoModule),
            },
            ...
            { path: 'overlay', loadChildren: () => import('@pages/overlay/overlaydemo.module').then((m) => m.OverlayDemoModule) },
            {
                ...
                loadChildren: () => import('@pages/animate/animateonscrolldemo.module').then((m) => m.AnimateOnScrollDemoModule),
            },
