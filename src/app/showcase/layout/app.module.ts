...
import { AppNewsModule } from './news/app.news.module';
import { AppTopbarModule } from './topbar/app.topbar.module';

@NgModule({
    declarations: [AppComponent, AppFooterComponent, AppMainComponent],
    imports: [FormsModule, ReactiveFormsModule, AppRoutingModule, AppNewsModule, HttpClientModule, BrowserAnimationsModule, LandingModule, AppConfigModule, AppTopbarModule, AppMenuModule],
