    ...
    template: `
        <div class="layout-news">
            <div class="layout-news-container" (click)="redirect()">
                <img class="layouts-news-mockup-image" src="assets/showcase/images/topbar-verona-device.png">
                <a href="https://www.primefaces.org/verona-ng" target="_blank"  style="text-decoration: none" class="layout-news-button">
