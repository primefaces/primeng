...
import {InputTextDirective} from '../../inputtext/inputtext.directive';
...
@Component({
    template: `
        ...
        <div class="ContentSideSections Implementation">
            ...
            <h3>Active Index - {{activeTabIndex}}</h3>
    ...
    `,
    directives: [TabViewComponent,TabPanelComponent,InputTextDirective]
})
