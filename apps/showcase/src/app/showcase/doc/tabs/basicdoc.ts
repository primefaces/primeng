...
@Component({
    ...
    template: `
        <app-docsectiontext>
            <p>
                Tabs is defined using <i>TabList</i>, <i>Tab</i>, <i>TabPanels</i> and <i>TabPanel</i> components. Tab and TabPanel
                components are associated with their <i>value</i> properties
            </p>
        </app-docsectiontext>
        <div class="card">
            <p-tabs value="0">
