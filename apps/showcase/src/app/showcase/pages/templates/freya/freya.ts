...
@Component({
    ...
    template: `<div class="freya template">
        ...
        <div [style.display]="'none'">
            <freya-separator></freya-separator>
            <template-youtube
                imgSrc="https://primefaces.org/cdn/primeng/images/templates/freya/freya-youtube-screen.png"
            ></template-youtube>
        </div>
...
export class FreyaPage {
    ...
    templateHeroData = {
        ...
        description:
            'Freya is a modern and clean application template for PrimeNG featuring a dark mode, attractive themes, customizable menu orientations, CSS widgets and template pages.',
    ...
    animationFeaturesData1 = [
        ...
        },
        {
            ...
            title: 'PrimeIcons',
            description:
                'Freya ships with PrimeIcons, PrimeTek’s modern icon library including a wide range of icons for your applications.',
