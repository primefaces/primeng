...
@Component({
    ...
    template: `
        ...
        <div class="card">
            <p-picklist [source]="sourceProducts" [target]="targetProducts" [dragdrop]="true" [responsive]="true" breakpoint="1400px" scrollHeight="20rem">
...
export class BasicDoc {
    ...
    code: Code = {
        basic: `<p-picklist [source]="sourceProducts" [target]="targetProducts" [dragdrop]="true" [responsive]="true" breakpoint="1400px" scrollHeight="20rem">
    <ng-template let-item #item>
        {{ item.name }}
    </ng-template>
</p-picklist>`,
