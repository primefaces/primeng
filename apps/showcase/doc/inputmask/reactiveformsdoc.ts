...
@Component({
    ...
    standalone: true,
    imports: [ReactiveFormsModule, InputMaskModule, ButtonModule, ToastModule, MessageModule, FluidModule, AppCodeModule, AppDocSectionText],
    template: `
        <app-docsectiontext>
        ...
        <app-code selector="input-mask-reactive-forms-demo"></app-code>
    `
})
