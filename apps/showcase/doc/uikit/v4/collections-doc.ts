...
@Component({
    ...
    template: `<app-docsectiontext>
        <ul class="leading-normal px-10 list-disc">
            ...
            <li class="py-2">
                <div class="font-bold">Component Common & Component Color Scheme</div>
                <p>
            ...
            <li class="py-2">
                ...
                <p>
                    Variables in this collection are not part of the <a href="https://github.com/primefaces/primeuix" target="_blank" rel="noopener noreferrer">PrimeUIX</a> system. They are intended for values defined in your own application. The
                    same applies to variables used in our UI library showcases. For example, there is no dedicated font size variable in <b>PrimeUIX</b> because font styles are not part of the design system. UI components inherit their font settings
