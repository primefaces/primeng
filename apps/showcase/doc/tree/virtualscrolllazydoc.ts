...
export class LazyVirtualScrollDoc implements OnInit {
    ...
    code: Code = {
        basic: `<p-tree class="w-full md:w-[30rem]" scrollHeight="250px" [virtualScroll]="true" [lazy]="true" [virtualScrollItemSize]="46" [value]="files" (onNodeExpand)="nodeExpand($event)" [loading]="loading" />`,
