...
export class ContextMenuDoc implements OnInit {
    ...
    code: Code = {
        basic: `<p-tree [value]="files()" class="w-full md:w-80" selectionMode="single" [(selection)]="selectedNode" [(contextMenuSelection)]="contextMenuNode" [contextMenu]="cm" contextMenuSelectionMode="separate" />
<p-contextmenu #cm [model]="items" />`,
    ...
    <p-contextmenu #cm [model]="items" />
        ...
        typescript: `import { ChangeDetectionStrategy, Component, model, OnInit, signal } from '@angular/core';
import { MenuItem, MessageService, TreeNode } from 'primeng/api';
import { NodeService } from '@/service/nodeservice';
