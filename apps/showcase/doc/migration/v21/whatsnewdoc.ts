...
@Component({
    ...
    template: `
        <app-docsectiontext>
            ...
            <ul class="leading-normal px-10 list-disc">
                <li class="py-1">
                    The internal packages <i>@primeuix/styles</i> and <i>@primeuix/themes</i> should be version <i>2.0.2</i> or higher. These packages are updated automatically with a fresh install. If you encounter any issues with visuals or
