...
@Component({
    selector: 'slider-pt-component',
    standalone: true,
    imports: [AppDocSection],
    template: `
        <div class="doc-main">
            <div class="doc-intro"><h1>Slider Pass Through</h1></div>
...
export class PTComponent {
    docs = [
        ...
        { id: 'pt.doc.slider', label: 'Slider PT Options', component: AppDocApiTable, data: getPTOptions('Slider') }
    ];
}
