...
@Component({
    ...
    standalone: true,
    imports: [ReactiveFormsModule, MultiSelectModule, ButtonModule, ToastModule, MessageModule, AppCodeModule, AppDocSectionText, CommonModule],
    ...
    template: `
        ...
        <app-code selector="multi-select-reactive-forms-demo"></app-code>
    `
})
