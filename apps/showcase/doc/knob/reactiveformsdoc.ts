...
@Component({
    ...
    standalone: true,
    imports: [ReactiveFormsModule, KnobModule, ButtonModule, ToastModule, MessageModule, AppCodeModule, AppDocSectionText],
    template: `
        <app-docsectiontext>
        ...
        <app-code selector="knob-reactive-forms-demo"></app-code>
    `
})
