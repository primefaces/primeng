...
@Component({
    ...
    standalone: true,
    imports: [CommonModule, RouterModule, DataViewModule, ButtonModule, TagModule, AppCode, AppDocSectionText],
    ...
    template: `
        ...
        <app-code selector="data-view-pagination-demo" [extFiles]="extFiles"></app-code>
    `
})
