...
@Component({
    ...
    standalone: true,
    imports: [FormsModule, RatingModule, ButtonModule, ToastModule, MessageModule, AppCode, AppDocSectionText, CommonModule],
    ...
    template: `
        ...
        <app-code selector="multiselect-reactive-forms-demo"></app-code>
    `
})
