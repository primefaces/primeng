...
@Component({
    ...
    template: `
        <app-docsectiontext>
            <p>Severity defines the color of the badge, possible values are <i>success</i>, <i>info</i>, <i>warn</i>, <i>danger</i>, <i>help</i>, <i>primary</i>, <i>secondary</i>, and <i>contrast</i>.</p>
        </app-docsectiontext>
