...
@Component({
    ...
    standalone: true,
    imports: [CommonModule, FormsModule, AppDocSectionText, AppCode, AppDemoWrapper, StepperModule, ButtonModule, PasswordModule, ToggleButtonModule, InputTextModule],
    template: `
        <app-docsectiontext>
