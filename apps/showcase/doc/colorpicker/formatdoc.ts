    ...
    template: `
        ...
        <div class="card flex flex-wrap gap-4">
            <div class="flex-1 flex flex-col items-center">
                ...
                <p-colorpicker [(ngModel)]="color" inputId="cp-hex" styleClass="mb-4" />
                <span>{{ color }}</span>
            </div>
            <div class="flex-1 flex flex-col items-center">
                <label for="cp-rgb" class="font-bold block mb-2"> RGB </label>
                <p-colorpicker [(ngModel)]="colorRGB" format="rgb" inputId="cp-rgb" styleClass="mb-4" />
                <span>{{ 'r:' + colorRGB.r + ' g:' + colorRGB.g + ' b:' + colorRGB.b }}</span>
            </div>
            <div class="flex-1 flex flex-col items-center">
                <label for="cp-hsb" class="font-bold block mb-2"> HSB </label>
                <p-colorpicker [(ngModel)]="colorHSB" format="hsb" inputId="cp-hsb" styleClass="mb-4" />
