...
@Component({
    ...
    template: `<section class="mb-6">
            <span class="block text-base font-semibold mb-2">Theme Name</span>
            <input [(ngModel)]="themeName" type="text" autocomplete="off" class="text-sm px-2.5 py-1.5 rounded-md border border-surface-300 dark:border-surface-700 flex-1" maxlength="25" />
        </section>
        <section class="mb-6">
            <div class="text-base font-semibold mb-2">Foundation</div>
            ...
            <div class="flex flex-col">
                <div class="flex flex-col gap-4 border border-surface-200 dark:border-surface-700 rounded-md p-4">
                    <div class="flex items-center gap-2">
                        ...
                        <span class="text-sm font-semibold">Base Theme</span>
                    </div>
                    <span class="text-sm text-muted-color">Variety of built-in themes with distinct characteristics.</span>
                        ...
                        <div class="flex">
                            @for (presetOption of presetOptions; track presetOption.value) {
                                <button
                                    ...
                                    class="border border-surface-200 dark:border-surface-700 px-3 py-2 border-r-0 last:border-r first:rounded-l-md last:rounded-r-md transition-colors duration-200 text-sm"
                                    [ngClass]="{
                ...
                <div class="flex flex-col gap-4 border border-surface-200 dark:border-surface-700 rounded-md p-4">
                    <div class="flex items-center gap-1">
                        ...
                        <span class="text-sm font-semibold"> Import Figma Variables </span>
                    </div>
                    <span class="text-sm text-muted-color leading-6"
                        >Export the token.json file using the
                        <a href="https://www.figma.com/community/plugin/1592914021886732603/primeui-theme-generator" target="_blank" rel="noopener noreferrer" class="hover:underline font-medium">PrimeUI Theme Generator</a> Figma plugin and import the
                ...
                <div class="flex flex-col gap-4 border border-surface-200 dark:border-surface-700 rounded-md p-4">
                    <div class="flex items-center gap-1">
                        ...
                        <span class="text-sm font-semibold">Sync with Figma</span>
                    </div>
                    <span class="text-sm text-muted-color leading-6"
                        >Generate and synchronize theme code directly from Figma to your remote repository using the Figma plugin. This automated workflow eliminates manual export/import steps, optimizes the theme generation process.
                    </span>
