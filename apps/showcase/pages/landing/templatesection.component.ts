            ...
            <section class="templates templates-animation flex justify-center items-center flex-col mt-7">
                ...
                <div class="flex my-6 md:flex-row flex-col gap-6 lg:gap-0">
                    ...
                    <div class="template-block block-middle mr-2 hidden lg:flex justify-center items-center flex-col">
                        <img
                            height="110"
                            [src]="isDarkMode ? 'https://primefaces.org/cdn/primevue/images/landing/templates/templates-text-noir-dark.png' : 'https://primefaces.org/cdn/primevue/images/landing/templates/templates-text-noir-light.png'"
                        />
                    </div>
                    <div
