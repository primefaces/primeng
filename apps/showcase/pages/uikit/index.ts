...
@Component({
    ...
    template: ` <div>
        ...
        <div class="card" style="border-radius: 50px">
            <span class="block font-bold text-4xl mb-7 text-center text-surface-900 dark:text-surface-0">Frequently Asked Questions</span>
            <div class="grid grid-cols-12 gap-4">
                <div class="col-span-12 lg:col-span-4 px-2 lg:px-7">
                    <div class="text-lg text-surface-900 dark:text-surface-0 leading-normal mb-2 font-medium">What do I get when I purchase a license?</div>
                    <p class="mt-0 mb-11 p-0 leading-normal text-surface-800 dark:text-surface-50">You'll be able to download the Figma file of PrimeOne UI Kit.</p>

                    <div class="text-lg text-surface-900 dark:text-surface-0 leading-normal mb-2 font-medium">Is there a recurring fee or is the license perpetual?</div>
                    <p class="mt-0 mb-11 p-0 leading-normal text-surface-800 dark:text-surface-50">UI Kit license is perpetual so requires one time payment, not subscription based.</p>

                    <div class="text-lg text-surface-900 dark:text-surface-0 leading-normal mb-2 font-medium">Can I use UI Kit license for commercial projects?</div>
                    <p class="mt-0 mb-11 p-0 leading-normal text-surface-800 dark:text-surface-50">Yes, your license allows you to sell your projects that utilize the UI Kit implementations.</p>

                    <div class="text-lg text-surface-900 dark:text-surface-0 leading-normal mb-2 font-medium">Can I create multiple projects for multiple clients?</div>
                    <p class="mt-0 mb-11 p-0 leading-normal text-surface-800 dark:text-surface-50">There is no limit, you are able to use UI Kit in multiple projects for multiple clients.</p>
                </div>
                <div class="col-span-12 lg:col-span-4 px-2 lg:px-7">
                    <div class="text-lg text-surface-900 dark:text-surface-0 leading-normal mb-2">We're a reseller, are we able to purchase a license on behalf of our client?</div>
                    <p class="mt-0 mb-11 p-0 leading-normal text-surface-800 dark:text-surface-50">
                    ...
                    <div class="text-lg text-surface-900 dark:text-surface-0 leading-normal mb-2 font-medium">Does the enterprise license include contractors within the organization?</div>
                    <p class="mt-0 mb-11 p-0 leading-normal text-surface-800 dark:text-surface-50">Yes, contractors are also able to use the UI Kit within your company.</p>

                    <div class="text-lg text-surface-900 dark:text-surface-0 leading-normal mb-2 font-medium">Can subsidiary company of a larger organization share the enterprise license?</div>
                    <p class="mt-0 mb-11 p-0 leading-normal text-surface-800 dark:text-surface-50">No, enterprise license is per company so each subsidiary company needs to purchase a separate license.</p>

                    <div class="text-lg text-surface-900 dark:text-surface-0 leading-normal mb-2 font-medium">What does "free updates" mean?</div>
                    <p class="mt-0 mb-11 p-0 leading-normal text-surface-800 dark:text-surface-50">All updates will be totally free of charge for existing customers for an unlimited period.</p>
                </div>
                <div class="col-span-12 lg:col-span-4 px-2 lg:px-7">
                    <div class="text-lg text-surface-900 dark:text-surface-0 leading-normal mb-2 font-medium">How can I get support?</div>
                    <p class="mt-0 mb-11 p-0 leading-normal text-surface-800 dark:text-surface-50">
                    ...
                    <div class="text-lg text-surface-900 dark:text-surface-0 leading-normal mb-2 font-medium">What does lifetime support mean?</div>
                    <p class="mt-0 mb-11 p-0 leading-normal text-surface-800 dark:text-surface-50">Support service at the forum does not have a time limit.</p>

                    <div class="text-lg text-surface-900 dark:text-surface-0 leading-normal mb-2 font-medium">Can I include UI Kit in an open source project?</div>
                    <p class="mt-0 mb-11 p-0 leading-normal text-surface-800 dark:text-surface-50">Due to the license, it is not possible to use the UI Kit in an open source project where the design files are publicly available.</p>
                </div>
            </div>
        </div>
    </div>`
