import { ElementRef, OnDestroy, DoCheck, EventEmitter, IterableDiffers, OnInit, AfterViewChecked } from '@angular/core';
export declare class Schedule implements DoCheck, OnDestroy, OnInit, AfterViewChecked {
    el: ElementRef;
    events: any[];
    header: any;
    style: any;
