...
import { TranslationKeys, FilterService, PrimeNGConfig, Footer, Header, PrimeTemplate, SharedModule } from 'primeng/api';
...
class MultiSelect {
    ...
    get optionsToRender() {
        var _a, _b;
        this.listSet = ((_a = this._filteredOptions) === null || _a === void 0 ? void 0 : _a.length) || ((_b = this.options) === null || _b === void 0 ? void 0 : _b.length);
