...
@Component({
    templateUrl: 'showcase/demo/chart/polarareachart/polarareachartdemo.component.html',
    directives: [PolarAreaChart,Button,Growl,TabPanel,TabView,ROUTER_DIRECTIVES]
})
